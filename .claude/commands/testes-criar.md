...
> **SSOT:** espelho de `.cursor/commands/testes-criar.md` — alterar nos dois lugares.
...
| EMT | `plano-teste-em-tela.md` | `run-{feature}.ts` | ver seção **Formato EMT obrigatório** abaixo |
