...
|------|----------|-------------|
| `SUPER_ADMIN` | **Todos** os logs de **todos** os tenants | `/admin/historico-global` (Painel Gravity) |
| `ADMIN` | **Todos** os logs de **todos** os tenants | `/admin/historico-global` (Painel Gravity) |
| `MASTER` | Todos os logs do **próprio tenant** (toda a organização) | `/configurador/historico-organizacao` |
| `STANDARD` | Apenas os logs onde **ele próprio** foi o ator | `/configurador/historico-organizacao` |
| `SUPPLIER` | Apenas os logs onde **ele próprio** foi o ator | `/configurador/historico-organizacao` |
...
1. Acessar `/configurador/historico-organizacao` → aba "Alertas" → botão "Nova Regra"
...
1. Ir em `/configurador/historico-organizacao` (MASTER) ou `/admin/historico-global` (SUPER_ADMIN/ADMIN)
...
1. Abrir o alerta em `/configurador/historico-organizacao` → aba "Alertas"
