...
| [LISTA-E-PROGRESSO-TECNICO.md](./LISTA-E-PROGRESSO-TECNICO.md) | Lista por workspace, layout/paginação/painéis, BFF leituras, progresso por usuário, nome do wizard |
