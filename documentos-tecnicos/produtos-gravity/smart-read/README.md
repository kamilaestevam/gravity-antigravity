...
| **TASK-000334** / PR #445 | Wizard passo 1: exclusão de arquivo com confirmação (modal acima do wizard), persistência local/progresso; `DELETE` legado ainda `501` — ver [LISTA-E-PROGRESSO-TECNICO.md](./LISTA-E-PROGRESSO-TECNICO.md) §3 |
