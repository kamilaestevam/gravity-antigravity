...
|--------|----|-----------|---------|
| ❌ | **TAB-Aberto.01** | Tab "Aberto" está visível na barra de tabs | 10.10s |
...
| ❌ | **TAB-Aberto.03** | Tab "Aberto" fica com estilo ativo após clicar | 30.09s |
  > `[2mexpect([22m[31mreceived[39m[2m).[22mtoBe[2m([22m[32mexpected[39m[2m) // Object.is equality[22m

Expected: [32mtrue[39m
Received: [31mfalse[39m`
| ❌ | **TAB-Aberto.04** | Tabela permanece visível após clicar em "Aberto" | 5.43s |
  > `[2mexpect([22m[31mlocator[39m[2m).[22mtoBeVisible[2m([22m[2m)[22m failed
...
| ❌ | **TAB-Aberto.06** | Badges visíveis após tab "Aberto" são todos do tipo correto | 0.01s |
  > `locator.count: Target page, context or browser has been closed`

*Gerado em 2026-04-15_02-25 por lista-pedidos.monitoring.spec.ts*
