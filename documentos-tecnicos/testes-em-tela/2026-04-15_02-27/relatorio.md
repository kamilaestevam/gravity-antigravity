...
[2m `
| ✅ | **TAB-Em_Andamento.02** | Clicar "Em Andamento" não recarrega a página (SPA) | 0.66s |
| ❌ | **TAB-Em_Andamento.03** | Tab "Em Andamento" fica com estilo ativo após clicar | 30.14s |
  > `[2mexpect([22m[31mreceived[39m[2m).[22mtoBe[2m([22m[32mexpected[39m[2m) // Object.is equality[22m

Expected: [32mtrue[39m
Received: [31mfalse[39m`
| ❌ | **TAB-Em_Andamento.04** | Tabela permanece visível após clicar em "Em Andamento" | 5.40s |
  > `[2mexpect([22m[31mlocator[39m[2m).[22mtoBeVisible[2m([22m[2m)[22m failed
...
*Gerado em 2026-04-15_02-27 por lista-pedidos.monitoring.spec.ts*
