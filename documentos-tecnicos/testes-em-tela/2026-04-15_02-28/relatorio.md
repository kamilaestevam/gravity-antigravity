...
|--------|----|-----------|---------|
| ❌ | **TAB-Aprovado.01** | Tab "Aprovado" está visível na barra de tabs | 10.06s |
...
| ❌ | **TAB-Aprovado.04** | Tabela permanece visível após clicar em "Aprovado" | 5.02s |
  > `[2mexpect([22m[31mlocator[39m[2m).[22mtoBeVisible[2m([22m[2m)[22m failed
...
`
| ❌ | **TAB-Aprovado.05** | Se tab "Aprovado" vazia: exibe mensagem de estado vazio (não tela em branco) | 0.01s |
...
*Gerado em 2026-04-15_02-28 por lista-pedidos.monitoring.spec.ts*
