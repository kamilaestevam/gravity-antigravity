...
|--------|----|-----------|---------|
| ❌ | **TAB-Transferido.01** | Tab "Transferido" está visível na barra de tabs | 10.07s |
...
[2m  `
| ✅ | **TAB-Transferido.02** | Clicar "Transferido" não recarrega a página (SPA) | 0.65s |
| ❌ | **TAB-Transferido.03** | Tab "Transferido" fica com estilo ativo após clicar | 30.09s |
  > `[2mexpect([22m[31mreceived[39m[2m).[22mtoBe[2m([22m[32mexpected[39m[2m) // Object.is equality[22m

Expected: [32mtrue[39m
Received: [31mfalse[39m`
| ❌ | **TAB-Transferido.04** | Tabela permanece visível após clicar em "Transferido" | 5.05s |
  > `[2mexpect([22m[31mlocator[39m[2m).[22mtoBeVisible[2m([22m[2m)[22m failed
...
*Gerado em 2026-04-15_02-31 por lista-pedidos.monitoring.spec.ts*
