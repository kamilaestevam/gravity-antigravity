...
[2m  `
| ✅ | **TAB-Consolidado.02** | Clicar "Consolidado" não recarrega a página (SPA) | 0.65s |
| ❌ | **TAB-Consolidado.03** | Tab "Consolidado" fica com estilo ativo após clicar | 30.11s |
  > `[2mexpect([22m[31mreceived[39m[2m).[22mtoBe[2m([22m[32mexpected[39m[2m) // Object.is equality[22m

Expected: [32mtrue[39m
Received: [31mfalse[39m`
| ❌ | **TAB-Consolidado.04** | Tabela permanece visível após clicar em "Consolidado" | 5.47s |
  > `[2mexpect([22m[31mlocator[39m[2m).[22mtoBeVisible[2m([22m[2m)[22m failed
...
| ❌ | **TAB-Consolidado.06** | Badges visíveis após tab "Consolidado" são todos do tipo correto | 0.01s |
  > `locator.count: Target page, context or browser has been closed`

*Gerado em 2026-04-15_02-34 por lista-pedidos.monitoring.spec.ts*
