...
|--------|----|-----------|---------|
| ❌ | **TAB-Cancelado.01** | Tab "Cancelado" está visível na barra de tabs | 10.06s |
...
[2m  - `
| ✅ | **TAB-Cancelado.02** | Clicar "Cancelado" não recarrega a página (SPA) | 0.66s |
| ❌ | **TAB-Cancelado.03** | Tab "Cancelado" fica com estilo ativo após clicar | 30.06s |
  > `[2mexpect([22m[31mreceived[39m[2m).[22mtoBe[2m([22m[32mexpected[39m[2m) // Object.is equality[22m

Expected: [32mtrue[39m
Received: [31mfalse[39m`
| ❌ | **TAB-Cancelado.04** | Tabela permanece visível após clicar em "Cancelado" | 5.07s |
  > `[2mexpect([22m[31mlocator[39m[2m).[22mtoBeVisible[2m([22m[2m)[22m failed
...
| ❌ | **TAB-Cancelado.06** | Badges visíveis após tab "Cancelado" são todos do tipo correto | 0.00s |
  > `locator.count: Target page, context or browser has been closed`

*Gerado em 2026-04-15_02-35 por lista-pedidos.monitoring.spec.ts*
