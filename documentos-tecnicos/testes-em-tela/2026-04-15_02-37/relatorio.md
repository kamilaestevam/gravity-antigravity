...
|--------|----|-----------|---------|
| ❌ | **G.01** | Campo de busca global visível na toolbar | 10.05s |
...
`
| ❌ | **G.02** | Placeholder do campo de busca é "Buscar pedido, exportador, referência..." | 15.05s |
...
`
| ❌ | **G.03** | Digitar 3 chars filtra a tabela sem recarregar a página | 15.05s |
  > `locator.fill: Timeout 15000ms exceeded.
Call log:
[2m  - waiting for locator('input[placeholder*="uscar"], input[placeholder*="Buscar"]').first()[22m
`
| ❌ | **G.04** | Pressionar Escape com campo focado limpa o valor | 5.65s |
...
*Gerado em 2026-04-15_02-37 por lista-pedidos.monitoring.spec.ts*
