...
export function ModalSelectGlobal({
  ...
  return (
    <div className={`modal-campo-select-global ${className}`}>
      {titulo && (
        <p className="modal-campo-select-global__title" style={{ width: 'max-content' }}>
          {icone}
          {titulo}
        </p>
      )}
      ...
      {descricao && (
        <p className="modal-campo-select-global__desc">
          {descricao}
        </p>
      )}

      <div className="modal-campo-select-global__row">
        <div className="modal-campo-select-global__field ws-field">
          {labelContext && <label>{labelContext}</label>}
          {selectElement}
        </div>
        {botoesAcao && (
          <div className="modal-campo-select-global__action">
            {botoesAcao}
          </div>
        )}
      </div>
      ...
      {itemAtivo && (
        <div className="modal-campo-select-global__active">
          {itemAtivo.icone}
          <span>
            {itemAtivo.texto}&nbsp;
            {itemAtivo.subtexto && (
              <span className="modal-campo-select-global__active-sub">
                {itemAtivo.subtexto}
              </span>
            )}
          </span>
