/**
 * @nucleo/modal-sem-sessoes-global — use-modal
 * Hook de abertura/fechamento de modais via modal-manager.
 */
import { useState, useEffect, useCallback } from 'react';
import { abrirModal, fecharModal, fecharUltimoModal, fecharTodosModais, subscribeModais, isModalAberto, } from './modal-manager.js';
// ─── useModal ─────────────────────────────────────────────────────────────────
/**
 ...
 * <ModalSemSessoesGlobal aberto={aberto} aoFechar={fechar} titulo="..." />
 */
