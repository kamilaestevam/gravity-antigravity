 ...
 * Fonte: Portal Único Siscomex / BACEN — Tabela completa (~110 moedas ativas)
 * Códigos numéricos conforme tabela oficial Siscomex (divergem do ISO 4217 em alguns casos).
