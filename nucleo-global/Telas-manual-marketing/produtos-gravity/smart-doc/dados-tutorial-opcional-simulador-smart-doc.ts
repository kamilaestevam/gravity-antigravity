...
export const TELAS_TUTORIAL_OPCIONAL: Record<string, TelaTutorialOpcional> = {
  ...
  'nova-leitura-1': {
    ...
    explorar: [
      ...
      { titulo: 'Zona de simulação', descricao: 'Clique na caixa central — não abre seletor de arquivo, apenas dispara o PDF demo', idAlvo: 'nl-dropzone' },
      { titulo: 'Arquivos simulados', descricao: 'Após o clique, o PDF demo aparece na lista da lateral com status', idAlvo: 'nl-arquivos-lateral' },
  ...
  'conferencia-campos': {
    ...
    avancar: {
      acao: 'Passo 3 de 4',
      titulo: 'Explore riscos ou avance',
      descricao: 'Teste as abas Análise de Riscos e Consultor, depois clique Avançar na lateral',
      idAlvo: 'conf-abas-principais',
    },
  },
  'conferencia-riscos': {
