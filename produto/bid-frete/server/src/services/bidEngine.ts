...
const WHATSAPP_SERVICE_URL = process.env.WHATSAPP_SERVICE_URL ?? 'http://localhost:8019'
const ATIVIDADES_SERVICE_URL = process.env.ATIVIDADES_SERVICE_URL ?? 'http://localhost:8012'
const NOTIFICACOES_SERVICE_URL = process.env.NOTIFICACOES_SERVICE_URL ?? 'http://localhost:8013'
const HISTORICO_SERVICE_URL = process.env.HISTORICO_SERVICE_URL ?? 'http://localhost:8014'
