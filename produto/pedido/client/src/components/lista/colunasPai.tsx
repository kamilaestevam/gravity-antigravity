...
export function buildColunasPai(t: TFunction): GTColuna<Pedido>[] {
  ...
  // ── Datas — Draft do Pedido ─────────────────────────────────────────────────
  {
    ...
    label: t('pedido.coluna_pai.data_prevista_recebimento_draft_pedido'),
    tipo: 'periodo',
    filtravel: true,
    sortavel: true,
    grupo: 'Datas',
    tooltipTitulo: t('pedido.coluna_pai.data_prevista_recebimento_draft_pedido_titulo'),
    tooltipDescricao: t('pedido.coluna_pai.data_prevista_recebimento_draft_pedido_desc'),
  ...
  },
  {
    ...
    label: t('pedido.coluna_pai.data_confirmada_recebimento_draft_pedido'),
    tipo: 'periodo',
    filtravel: true,
    sortavel: true,
    grupo: 'Datas',
    tooltipTitulo: t('pedido.coluna_pai.data_confirmada_recebimento_draft_pedido_titulo'),
    tooltipDescricao: t('pedido.coluna_pai.data_confirmada_recebimento_draft_pedido_desc'),
  ...
  },
  {
    ...
    label: t('pedido.coluna_pai.data_meta_recebimento_draft_pedido'),
    tipo: 'periodo',
    filtravel: true,
    sortavel: true,
    grupo: 'Datas',
    tooltipTitulo: t('pedido.coluna_pai.data_meta_recebimento_draft_pedido_titulo'),
    tooltipDescricao: t('pedido.coluna_pai.data_meta_recebimento_draft_pedido_desc'),
  ...
  },
  {
    ...
    label: t('pedido.coluna_pai.data_prevista_aprovacao_draft_pedido'),
    tipo: 'periodo',
    filtravel: true,
    sortavel: true,
    grupo: 'Datas',
    tooltipTitulo: t('pedido.coluna_pai.data_prevista_aprovacao_draft_pedido_titulo'),
    tooltipDescricao: t('pedido.coluna_pai.data_prevista_aprovacao_draft_pedido_desc'),
  ...
  },
  {
    ...
    label: t('pedido.coluna_pai.data_confirmada_aprovacao_draft_pedido'),
    tipo: 'periodo',
    filtravel: true,
    sortavel: true,
    grupo: 'Datas',
    tooltipTitulo: t('pedido.coluna_pai.data_confirmada_aprovacao_draft_pedido_titulo'),
    tooltipDescricao: t('pedido.coluna_pai.data_confirmada_aprovacao_draft_pedido_desc'),
  ...
  },
  {
    ...
    label: t('pedido.coluna_pai.data_meta_aprovacao_draft_pedido'),
    tipo: 'periodo',
    filtravel: true,
    sortavel: true,
    grupo: 'Datas',
    tooltipTitulo: t('pedido.coluna_pai.data_meta_aprovacao_draft_pedido_titulo'),
    tooltipDescricao: t('pedido.coluna_pai.data_meta_aprovacao_draft_pedido_desc'),
  ...
  // ── Datas — Proforma Invoice ────────────────────────────────────────────────
  {
    ...
    label: t('pedido.coluna_pai.data_prevista_recebimento_draft_proforma'),
    tipo: 'periodo',
    filtravel: true,
    sortavel: true,
    grupo: 'Datas',
    tooltipTitulo: t('pedido.coluna_pai.data_prevista_recebimento_draft_proforma_titulo'),
    tooltipDescricao: t('pedido.coluna_pai.data_prevista_recebimento_draft_proforma_desc'),
  ...
  },
  {
    ...
    label: t('pedido.coluna_pai.data_confirmada_recebimento_draft_proforma'),
    tipo: 'periodo',
    filtravel: true,
    sortavel: true,
    grupo: 'Datas',
    tooltipTitulo: t('pedido.coluna_pai.data_confirmada_recebimento_draft_proforma_titulo'),
    tooltipDescricao: t('pedido.coluna_pai.data_confirmada_recebimento_draft_proforma_desc'),
  ...
  },
  {
    ...
    label: t('pedido.coluna_pai.data_meta_recebimento_draft_proforma'),
    tipo: 'periodo',
    filtravel: true,
    sortavel: true,
    grupo: 'Datas',
    tooltipTitulo: t('pedido.coluna_pai.data_meta_recebimento_draft_proforma_titulo'),
    tooltipDescricao: t('pedido.coluna_pai.data_meta_recebimento_draft_proforma_desc'),
  ...
  },
  {
    ...
    label: t('pedido.coluna_pai.data_prevista_aprovacao_draft_proforma'),
    tipo: 'periodo',
    filtravel: true,
    sortavel: true,
    grupo: 'Datas',
    tooltipTitulo: t('pedido.coluna_pai.data_prevista_aprovacao_draft_proforma_titulo'),
    tooltipDescricao: t('pedido.coluna_pai.data_prevista_aprovacao_draft_proforma_desc'),
  ...
  },
  {
    ...
    label: t('pedido.coluna_pai.data_confirmada_aprovacao_draft_proforma'),
    tipo: 'periodo',
    filtravel: true,
    sortavel: true,
    grupo: 'Datas',
    tooltipTitulo: t('pedido.coluna_pai.data_confirmada_aprovacao_draft_proforma_titulo'),
    tooltipDescricao: t('pedido.coluna_pai.data_confirmada_aprovacao_draft_proforma_desc'),
  ...
  },
  {
    ...
    label: t('pedido.coluna_pai.data_meta_aprovacao_draft_proforma'),
    tipo: 'periodo',
    filtravel: true,
    sortavel: true,
    grupo: 'Datas',
    tooltipTitulo: t('pedido.coluna_pai.data_meta_aprovacao_draft_proforma_titulo'),
    tooltipDescricao: t('pedido.coluna_pai.data_meta_aprovacao_draft_proforma_desc'),
  ...
  // ── Datas — Invoice ─────────────────────────────────────────────────────────
  {
    ...
    label: t('pedido.coluna_pai.data_prevista_recebimento_draft_invoice'),
    tipo: 'periodo',
    filtravel: true,
    sortavel: true,
    grupo: 'Datas',
    tooltipTitulo: t('pedido.coluna_pai.data_prevista_recebimento_draft_invoice_titulo'),
    tooltipDescricao: t('pedido.coluna_pai.data_prevista_recebimento_draft_invoice_desc'),
  ...
  },
  {
    ...
    label: t('pedido.coluna_pai.data_confirmada_recebimento_draft_invoice'),
    tipo: 'periodo',
    filtravel: true,
    sortavel: true,
    grupo: 'Datas',
    tooltipTitulo: t('pedido.coluna_pai.data_confirmada_recebimento_draft_invoice_titulo'),
    tooltipDescricao: t('pedido.coluna_pai.data_confirmada_recebimento_draft_invoice_desc'),
  ...
  },
  {
    ...
    label: t('pedido.coluna_pai.data_meta_recebimento_draft_invoice'),
    tipo: 'periodo',
    filtravel: true,
    sortavel: true,
    grupo: 'Datas',
    tooltipTitulo: t('pedido.coluna_pai.data_meta_recebimento_draft_invoice_titulo'),
    tooltipDescricao: t('pedido.coluna_pai.data_meta_recebimento_draft_invoice_desc'),
  ...
  },
  {
    ...
    label: t('pedido.coluna_pai.data_prevista_aprovacao_draft_invoice'),
    tipo: 'periodo',
    filtravel: true,
    sortavel: true,
    grupo: 'Datas',
    tooltipTitulo: t('pedido.coluna_pai.data_prevista_aprovacao_draft_invoice_titulo'),
    tooltipDescricao: t('pedido.coluna_pai.data_prevista_aprovacao_draft_invoice_desc'),
  ...
  },
  {
    ...
    label: t('pedido.coluna_pai.data_confirmada_aprovacao_draft_invoice'),
    tipo: 'periodo',
    filtravel: true,
    sortavel: true,
    grupo: 'Datas',
    tooltipTitulo: t('pedido.coluna_pai.data_confirmada_aprovacao_draft_invoice_titulo'),
    tooltipDescricao: t('pedido.coluna_pai.data_confirmada_aprovacao_draft_invoice_desc'),
  ...
  },
  {
    ...
    label: t('pedido.coluna_pai.data_meta_aprovacao_draft_invoice'),
    tipo: 'periodo',
    filtravel: true,
    sortavel: true,
    grupo: 'Datas',
    tooltipTitulo: t('pedido.coluna_pai.data_meta_aprovacao_draft_invoice_titulo'),
    tooltipDescricao: t('pedido.coluna_pai.data_meta_aprovacao_draft_invoice_desc'),
