...
DO $$ BEGIN
  CREATE TYPE "pedido"."StatusPedido" AS ENUM ('draft', 'aberto', 'em_andamento', 'aprovado', 'transferencia', 'consolidado', 'cancelado');
EXCEPTION WHEN duplicate_object THEN null; END $$;

DO $$ BEGIN
  CREATE TYPE "pedido"."TipoOperacao" AS ENUM ('importacao', 'exportacao');
EXCEPTION WHEN duplicate_object THEN null; END $$;

DO $$ BEGIN
  CREATE TYPE "pedido"."MoedaPedido" AS ENUM ('USD', 'EUR', 'CNY', 'JPY', 'GBP', 'BRL');
EXCEPTION WHEN duplicate_object THEN null; END $$;

DO $$ BEGIN
  CREATE TYPE "pedido"."IncotermPedido" AS ENUM ('FOB', 'CIF', 'EXW', 'CFR', 'FCA', 'DDP', 'DAP', 'CPT', 'CIP', 'DPU', 'FAS');
EXCEPTION WHEN duplicate_object THEN null; END $$;

DO $$ BEGIN
  CREATE TYPE "pedido"."UnidadeComercializada" AS ENUM ('UNID', 'KG', 'TON', 'M', 'M2', 'M3', 'LT', 'PARES', 'DUZIA', 'JOGO');
EXCEPTION WHEN duplicate_object THEN null; END $$;
