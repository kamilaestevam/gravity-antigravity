...
CREATE TABLE "pedido_produto_gravity" (
    ...
    "cobertura_cambial_pedido" TEXT,
    "quantidade_volumes_pedido" INTEGER,
    "data_documento_pedido" TIMESTAMP(3),
    "data_documento_proforma" TIMESTAMP(3),
    "data_documento_invoice" TIMESTAMP(3),
    "data_prevista_pedido_pronto" TIMESTAMP(3),
    "data_confirmada_pedido_pronto" TIMESTAMP(3),
    "data_meta_pedido_pronto" TIMESTAMP(3),
    "data_prevista_inspecao_pedido" TIMESTAMP(3),
    "data_confirmada_inspecao_pedido" TIMESTAMP(3),
    "data_meta_inspecao_pedido" TIMESTAMP(3),
    "data_prevista_coleta_pedido" TIMESTAMP(3),
    "data_confirmada_coleta_pedido" TIMESTAMP(3),
    "data_meta_coleta_pedido" TIMESTAMP(3),
    "data_prev_recebimento_draft_pedido" TIMESTAMP(3),
    "data_conf_recebimento_draft_pedido" TIMESTAMP(3),
    "data_meta_recebimento_draft_pedido" TIMESTAMP(3),
    "data_prev_aprovacao_draft_pedido" TIMESTAMP(3),
    "data_conf_aprovacao_draft_pedido" TIMESTAMP(3),
    "data_meta_aprovacao_draft_pedido" TIMESTAMP(3),
    "data_prev_recebimento_draft_proforma" TIMESTAMP(3),
    "data_conf_recebimento_draft_proforma" TIMESTAMP(3),
    "data_meta_recebimento_draft_proforma" TIMESTAMP(3),
    "data_prev_aprovacao_draft_proforma" TIMESTAMP(3),
    "data_conf_aprovacao_draft_proforma" TIMESTAMP(3),
    "data_meta_aprovacao_draft_proforma" TIMESTAMP(3),
    "data_prev_envio_original_proforma" TIMESTAMP(3),
    "data_conf_envio_original_proforma" TIMESTAMP(3),
    "data_meta_envio_original_proforma" TIMESTAMP(3),
    "data_prev_recebimento_original_proforma" TIMESTAMP(3),
    "data_conf_recebimento_original_proforma" TIMESTAMP(3),
    "data_meta_recebimento_original_proforma" TIMESTAMP(3),
    "data_prev_recebimento_draft_invoice" TIMESTAMP(3),
    "data_conf_recebimento_draft_invoice" TIMESTAMP(3),
    "data_meta_recebimento_draft_invoice" TIMESTAMP(3),
    "data_prev_aprovacao_draft_invoice" TIMESTAMP(3),
    "data_conf_aprovacao_draft_invoice" TIMESTAMP(3),
    "data_meta_aprovacao_draft_invoice" TIMESTAMP(3),
    "data_prev_envio_original_invoice" TIMESTAMP(3),
    "data_conf_envio_original_invoice" TIMESTAMP(3),
    "data_meta_envio_original_invoice" TIMESTAMP(3),
    "data_prev_recebimento_original_invoice" TIMESTAMP(3),
    "data_conf_recebimento_original_invoice" TIMESTAMP(3),
    "data_meta_recebimento_original_invoice" TIMESTAMP(3),
...
CREATE TABLE "tracking_items_transferidos" (
    ...
    "data_transferencia_qtd" TIMESTAMP(3),
