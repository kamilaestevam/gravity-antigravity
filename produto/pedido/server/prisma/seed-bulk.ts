...
async function main() {
  ...
  for (let i = 1; i <= total; i++) {
    ...
    const pedidoData = {
      ...
      condicao_pagamento: i % 2 === 0 ? '30% antecipado, 70% BL' : '100% carta de crédito',
      ...
      moeda_cambio: 'BRL',
      taxa_cambio_estimada: taxaCambio,
      valor_total_cambio: valorCambio,
      valor_total_pedido: valorTotal,
      quantidade_total_pedido: qtdItem,
