...
const pedidos = [
  // ─── 1. Importação de eletrônicos — status: aberto ──────────────────────
  {
    ...
    condicao_pagamento: '30% antecipado, 70% contra-entrega',
    ...
    itens: [
      {
        ...
        quantidade_inicial_pedido:     new Decimal('5000'),
        quantidade_atual_pedido:       new Decimal('5000'),
        ...
        moeda_item:         'USD',
        valor_por_unidade_item: new Decimal('2.450000'),
        valor_total_item:         new Decimal('12250.000000'),
      ...
      },
      {
        ...
        unidade_comercializada_item: 'PCS',
        quantidade_inicial_pedido:new Decimal('2000'),
        quantidade_atual_pedido:new Decimal('2000'),
        quantidade_pronta_pedido:new Decimal('0'),
        quantidade_transferida_pedido:new Decimal('0'),
        quantidade_cancelada_pedido:new Decimal('0'),
        casas_decimais_quantidade_item:0,
        moeda_item:         'USD',
        valor_por_unidade_item:new Decimal('8.750000'),
        valor_total_item:         new Decimal('17500.000000'),
        casas_decimais_total_item: 2,
      },
      {
        id: gerarId('pite'),
        ...
        unidade_comercializada_item: 'PCS',
        quantidade_inicial_pedido:new Decimal('500'),
        quantidade_atual_pedido:new Decimal('500'),
        quantidade_pronta_pedido:new Decimal('0'),
        quantidade_transferida_pedido:new Decimal('0'),
        quantidade_cancelada_pedido:new Decimal('0'),
        casas_decimais_quantidade_item:0,
        moeda_item:         'USD',
        valor_por_unidade_item:new Decimal('24.500000'),
        valor_total_item:         new Decimal('12250.000000'),
        casas_decimais_total_item: 2,
      },
    ],
  ...
  // ─── 2. Importação de químicos — status: transferencia ──────────────────
  {
    ...
    moeda_pedido:   'EUR',
    cobertura_cambial: 'com_cobertura',
    condicao_pagamento: 'Carta de Crédito à vista',
    ...
    itens: [
      {
        ...
        quantidade_inicial_pedido:new Decimal('4000.000'),
        quantidade_atual_pedido:new Decimal('2500.000'),
        quantidade_pronta_pedido:new Decimal('0'),
        quantidade_transferida_pedido:new Decimal('1500.000'),
        quantidade_cancelada_pedido:new Decimal('0'),
        casas_decimais_quantidade_item:3,
        moeda_item:         'EUR',
        valor_por_unidade_item:new Decimal('3.750000'),
        valor_total_item:         new Decimal('15000.000000'),
        casas_decimais_total_item: 2,
      },
      {
        id: gerarId('pite'),
        ...
        quantidade_inicial_pedido:new Decimal('200.000'),
        quantidade_atual_pedido:new Decimal('200.000'),
        quantidade_pronta_pedido:new Decimal('0'),
        quantidade_transferida_pedido:new Decimal('0'),
        quantidade_cancelada_pedido:new Decimal('0'),
        casas_decimais_quantidade_item:3,
        moeda_item:         'EUR',
        valor_por_unidade_item:new Decimal('12.800000'),
        valor_total_item:         new Decimal('2560.000000'),
        casas_decimais_total_item: 2,
      },
    ],
  },
  ...
  // ─── 3. Importação de EPI — status: consolidado ──────────────────────────
  {
    ...
    moeda_pedido:   'USD',
    cobertura_cambial: 'com_cobertura',
    condicao_pagamento: '60 dias data embarque',
    ...
    itens: [
      {
        ...
        quantidade_inicial_pedido:new Decimal('500'),
        quantidade_atual_pedido:new Decimal('0'),
        quantidade_pronta_pedido:new Decimal('0'),
        quantidade_transferida_pedido:new Decimal('500'),
        quantidade_cancelada_pedido:new Decimal('0'),
        casas_decimais_quantidade_item:0,
        moeda_item:         'USD',
        valor_por_unidade_item:new Decimal('28.600000'),
        valor_total_item:         new Decimal('14300.000000'),
        casas_decimais_total_item: 2,
      },
      {
        id: gerarId('pite'),
        ...
        unidade_comercializada_item: 'PCS',
        quantidade_inicial_pedido:new Decimal('300'),
        quantidade_atual_pedido:new Decimal('0'),
        quantidade_pronta_pedido:new Decimal('0'),
        quantidade_transferida_pedido:new Decimal('300'),
        quantidade_cancelada_pedido:new Decimal('0'),
        casas_decimais_quantidade_item:0,
        moeda_item:         'USD',
        valor_por_unidade_item:new Decimal('42.000000'),
        valor_total_item:         new Decimal('12600.000000'),
        casas_decimais_total_item: 2,
      },
      {
        id: gerarId('pite'),
        ...
        unidade_comercializada_item: 'PCS',
        quantidade_inicial_pedido:new Decimal('1000'),
        quantidade_atual_pedido:new Decimal('0'),
        quantidade_pronta_pedido:new Decimal('0'),
        quantidade_transferida_pedido:new Decimal('1000'),
        quantidade_cancelada_pedido:new Decimal('0'),
        casas_decimais_quantidade_item:0,
        moeda_item:         'USD',
        valor_por_unidade_item:new Decimal('7.900000'),
        valor_total_item:         new Decimal('7900.000000'),
        casas_decimais_total_item: 2,
      },
    ],
  },
  ...
  // ─── 4. Importação de máquinas — status: aberto ──────────────────────────
  {
    ...
    condicao_pagamento: '50% adiantado, 50% após FAT',
    ...
    itens: [
      {
        ...
        quantidade_inicial_pedido:new Decimal('1'),
        quantidade_atual_pedido:new Decimal('1'),
        quantidade_pronta_pedido:new Decimal('0'),
        quantidade_transferida_pedido:new Decimal('0'),
        quantidade_cancelada_pedido:new Decimal('0'),
        casas_decimais_quantidade_item:0,
        moeda_item:         'EUR',
        valor_por_unidade_item:new Decimal('78500.000000'),
        valor_total_item:         new Decimal('78500.000000'),
        casas_decimais_total_item: 2,
      },
      {
        id: gerarId('pite'),
        ...
        quantidade_inicial_pedido:new Decimal('2'),
        quantidade_atual_pedido:new Decimal('2'),
        quantidade_pronta_pedido:new Decimal('0'),
        quantidade_transferida_pedido:new Decimal('0'),
        quantidade_cancelada_pedido:new Decimal('0'),
        casas_decimais_quantidade_item:0,
        moeda_item:         'EUR',
        valor_por_unidade_item:new Decimal('3200.000000'),
        valor_total_item:         new Decimal('6400.000000'),
        casas_decimais_total_item: 2,
      },
    ],
  },
  ...
  // ─── 5. Exportação de calçados — status: aberto ──────────────────────────
  {
    ...
    moeda_pedido:   'USD',
    cobertura_cambial: 'com_cobertura',
    condicao_pagamento: 'Pagamento antecipado 100%',
    ...
    itens: [
      {
        ...
        quantidade_inicial_pedido:new Decimal('600'),
        quantidade_atual_pedido:new Decimal('600'),
        quantidade_pronta_pedido:new Decimal('400'),
        quantidade_transferida_pedido:new Decimal('0'),
        quantidade_cancelada_pedido:new Decimal('0'),
        casas_decimais_quantidade_item:0,
        moeda_item:         'USD',
        valor_por_unidade_item:new Decimal('45.000000'),
        valor_total_item:         new Decimal('27000.000000'),
        casas_decimais_total_item: 2,
      },
      {
        id: gerarId('pite'),
        ...
        unidade_comercializada_item: 'PAR',
        quantidade_inicial_pedido:new Decimal('200'),
        quantidade_atual_pedido:new Decimal('200'),
        quantidade_pronta_pedido:new Decimal('100'),
        quantidade_transferida_pedido:new Decimal('0'),
        quantidade_cancelada_pedido:new Decimal('0'),
        casas_decimais_quantidade_item:0,
        moeda_item:         'USD',
        valor_por_unidade_item:new Decimal('30.000000'),
        valor_total_item:         new Decimal('6000.000000'),
        casas_decimais_total_item: 2,
      },
    ],
  },
  ...
  // ─── 6. Exportação de grãos — status: transferencia ─────────────────────
  {
    ...
    moeda_pedido:   'USD',
    cobertura_cambial: 'com_cobertura',
    condicao_pagamento: '100% carta de crédito irrevogável',
    ...
    itens: [
      {
        ...
        quantidade_inicial_pedido:new Decimal('2000.000'),
        quantidade_atual_pedido:new Decimal('800.000'),
        quantidade_pronta_pedido:new Decimal('0'),
        quantidade_transferida_pedido:new Decimal('1200.000'),
        quantidade_cancelada_pedido:new Decimal('0'),
        casas_decimais_quantidade_item:3,
        moeda_item:         'USD',
        valor_por_unidade_item:new Decimal('400.000000'),
        valor_total_item:         new Decimal('800000.000000'),
        casas_decimais_total_item: 2,
      },
    ],
  },
