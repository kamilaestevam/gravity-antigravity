-- Fallback manual: rename empresa → fornecedor (mesmo conteúdo da migration 20260526120000)
-- Executar em gravity-cadastros-teste E gravity-cadastros-producao se migrate deploy falhar.
