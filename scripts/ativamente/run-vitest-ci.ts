...
const SUITES_FORA_DO_DEPLOY_GATE = new Set([
  ...
  'testes/testes-cross-organizacao/produto-gravity/pedido/vitest.config.ts',
  ...
  'testes/testes-unitarios/api-cockpit/vitest.config.ts',
  ...
  'testes/testes-unitarios/produto-gravity/bid-frete-internacional/vitest.config.ts',
