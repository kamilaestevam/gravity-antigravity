...
$mapa = @{
  ...
  'tela_smart_docs_configuracoes_cards' = 'smart-docs-configuracoes-cards.png'
  'tela_smart_docs_configuracoes_card_1' = 'smart-docs-configuracoes-cards-adicionar.png'
