...
const services = [
  ...
  { name: 'bid-cambio', routeRoot: 'produto/bid-cambio/server/src/routes', prismaFile: 'produto/bid-cambio/server/prisma/fragment.prisma' },
  { name: 'bid-frete', routeRoot: 'produto/bid-frete/server/src/routes', prismaFile: 'produto/bid-frete/server/prisma/fragment.prisma' },
  { name: 'financeiro-comex', routeRoot: 'produto/financeiro-comex/server/src/routes', prismaFile: 'produto/financeiro-comex/server/prisma/fragment.prisma' },
  { name: 'lpco', routeRoot: 'produto/lpco/server/src/routes', prismaFile: 'produto/lpco/server/prisma/fragment.prisma' },
  { name: 'nf-importacao', routeRoot: 'produto/nf-importacao/server/src/routes', prismaFile: 'produto/nf-importacao/server/prisma/fragment.prisma' },
  { name: 'pedido', routeRoot: 'produto/pedido/server/src/routes', prismaFile: 'produto/pedido/server/prisma/fragment.prisma' },
  { name: 'processo', routeRoot: 'produto/processo/server/src/routes', prismaFile: 'produto/processo/server/prisma/fragment.prisma' },
  { name: 'simula-custo', routeRoot: 'produto/simula-custo/server/src/routes', prismaFile: 'produto/simula-custo/server/prisma/fragment.prisma' },
]
