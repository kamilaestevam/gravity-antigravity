...
const TELAS: PlanDef[] = [
  // ─── Usuários ──────────────────────────────────────────────────────
  {
    ...
    passos: [
      ...
      { acao: 'Verificar edicao via API PATCH', categoria: 5, interacao: { tipo: 'verificacao' }, assercao: { tipo: 'apiResponse', rota: '/api/v1/usuarios', status: 200 }, resultadoEsperado: 'API retorna 200', tipos: ['E2E', 'FUN'] },
      ...
      { acao: 'Verificar API POST /users/invite chamada', categoria: 6, interacao: { tipo: 'verificacao' }, assercao: { tipo: 'apiResponse', rota: '/api/v1/usuarios/invite', status: 201 }, resultadoEsperado: 'API retorna 201', tipos: ['E2E', 'FUN'] },
      ...
      { acao: 'Verificar middleware requireAuth no backend', categoria: 14, interacao: { tipo: 'verificacao' }, assercao: { tipo: 'apiResponse', rota: '/api/v1/usuarios', status: 401 }, resultadoEsperado: 'Sem token retorna 401', tipos: ['FUN'] },
      // Cat 15: Multi-tenant
  ...
  // ─── Assinaturas ──────────────────────────────────────────────────
  {
    ...
    passos: [
      ...
      { acao: 'Verificar dados corretos via API', categoria: 4, interacao: { tipo: 'verificacao' }, assercao: { tipo: 'apiResponse', rota: '/api/v1/assinaturas', status: 200 }, resultadoEsperado: 'API retorna 200', tipos: ['E2E', 'FUN'] },
      ...
      { acao: 'Verificar POST /subscribe chamado', categoria: 6, interacao: { tipo: 'verificacao' }, assercao: { tipo: 'apiResponse', rota: '/api/v1/assinaturas/subscribe', status: 201 }, resultadoEsperado: 'API retorna 201', tipos: ['E2E', 'FUN'] },
  ...
  // ─── Workspaces ───────────────────────────────────────────────────
  {
    ...
    passos: [
      ...
      { acao: 'Verificar dados dos workspaces carregados', categoria: 4, interacao: { tipo: 'verificacao' }, assercao: { tipo: 'apiResponse', rota: '/api/v1/organizacao/companies', status: 200 }, resultadoEsperado: 'API retorna 200', tipos: ['E2E', 'FUN'] },
      ...
      { acao: 'Verificar PATCH via API', categoria: 5, interacao: { tipo: 'verificacao' }, assercao: { tipo: 'apiResponse', rota: '/api/v1/organizacao/companies', status: 200 }, resultadoEsperado: 'API atualiza corretamente', tipos: ['E2E', 'FUN'] },
      ...
      { acao: 'Verificar POST via API', categoria: 6, interacao: { tipo: 'verificacao' }, assercao: { tipo: 'apiResponse', rota: '/api/v1/organizacao/companies', status: 201 }, resultadoEsperado: 'API retorna 201', tipos: ['E2E', 'FUN'] },
      ...
      { acao: 'Verificar DELETE via API', categoria: 7, interacao: { tipo: 'verificacao' }, assercao: { tipo: 'apiResponse', rota: '/api/v1/organizacao/companies', status: 200 }, resultadoEsperado: 'API retorna 200', tipos: ['E2E', 'FUN'] },
