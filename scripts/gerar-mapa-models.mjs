...
const sources = [
  ...
  { local: 'Produto - pedido', produto: 'pedido', file: 'servicos-global/produto/pedido/server/prisma/fragment.prisma' },
  { local: 'Produto - processo', produto: 'processo', file: 'servicos-global/produto/processo/server/prisma/fragment.prisma' },
  { local: 'Produto - simula-custo', produto: 'simula-custo', file: 'servicos-global/produto/simula-custo/server/prisma/fragment.prisma' },
]
