/**
 * Verifica aeroportos leva Ásia 1 contra cadastros.aeroporto (IATA + UN/LOCODE).
 * Uso: npx tsx scripts/sob-demanda/verificar-aeroportos-leva-asia-1-cadastros.ts
 */
import { readFileSync } from 'node:fs'
import { resolve } from 'node:path'
import { PrismaClient } from '../../servicos-global/cadastros/generated/index.js'
import { AEROPORTOS_LEVA_ASIA_1 } from './data/aeroportos-leva-asia-1.js'
...
async function main() {
  ...
  for (const item of AEROPORTOS_LEVA_ASIA_1) {
  ...
  console.log(`\n=== LEVA AÉREO ÁSIA 1 — ${AEROPORTOS_LEVA_ASIA_1.length} aeroportos ===`)
