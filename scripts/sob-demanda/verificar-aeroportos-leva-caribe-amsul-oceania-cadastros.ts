/**
 * Verifica aeroportos leva Caribe/Am.Sul/BR/Oceania/Pacífico.
 * Uso: npx tsx scripts/sob-demanda/verificar-aeroportos-leva-caribe-amsul-oceania-cadastros.ts
 */
import { readFileSync } from 'node:fs'
import { resolve } from 'node:path'
import { PrismaClient } from '../../servicos-global/cadastros/generated/index.js'
import { AEROPORTOS_LEVA_CARIBE_AMSUL_OCEANIA } from './data/aeroportos-leva-caribe-amsul-oceania.js'
...
async function main() {
  ...
  for (const item of AEROPORTOS_LEVA_CARIBE_AMSUL_OCEANIA) {
  ...
  console.log(
    `\n=== LEVA AÉREO CARIBE/AMSUL/BR/OCEANIA — ${AEROPORTOS_LEVA_CARIBE_AMSUL_OCEANIA.length} aeroportos ===`,
  )
