/**
 * Verifica aeroportos leva Europa contra cadastros.aeroporto.
 * Uso: npx tsx scripts/sob-demanda/verificar-aeroportos-leva-europa-cadastros.ts
 */
import { readFileSync } from 'node:fs'
import { resolve } from 'node:path'
import { PrismaClient } from '../../servicos-global/cadastros/generated/index.js'
import { AEROPORTOS_LEVA_EUROPA } from './data/aeroportos-leva-europa.js'
...
async function main() {
  ...
  for (const item of AEROPORTOS_LEVA_EUROPA) {
  ...
  console.log(`\n=== LEVA AÉREO EUROPA — ${AEROPORTOS_LEVA_EUROPA.length} aeroportos ===`)
