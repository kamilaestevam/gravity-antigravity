...
export const productCatalogService = {
  ...
  async toggleStatus(id: string) {
    ...
    const newStatus = product.status === 'ATIVO' ? 'SUSPENSO' : 'ATIVO'
...
const seedProducts: Prisma.ProdutoGravityUncheckedCreateInput[] = [
  {
    ...
    status: 'ATIVO',
    billing_type: 'POR_ESTIMATIVA',
    unit_price: 10.99,
    minimum_price: 0,
    user_limit_type: 'LIMITADO',
    base_users_qty: 10,
  ...
  },
  {
    ...
    status: 'ATIVO',
    billing_type: 'POR_PROCESSO',
    has_setup: true,
    unit_price: 1.99,
    minimum_price: 199,
    user_limit_type: 'ILIMITADO',
