...
export function AuthPage() {
  ...
  return (
    <div className="auth-root">
      ...
      {/* ── Right Panel — Clerk SignIn / SignUp ── */}
      <div className="auth-form-panel">
        <div className="auth-form-header">
          <p className="auth-form-title">{isSignUp ? 'Criar sua conta' : 'Acessar a plataforma'}</p>
          <p className="auth-form-subtitle">{isSignUp ? 'Preencha os dados e comece agora' : 'Entre com suas credenciais para continuar'}</p>
        </div>
