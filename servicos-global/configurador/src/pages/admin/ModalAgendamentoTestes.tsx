      ...
      conteudo: (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', padding: '1.5rem' }}>
          ...
          <div style={{
            ...
            <span>Configurações globais de agendamento em modo de visualização.</span>
          </div>
            ...
            <GeralCampoGlobal label="AGENDAMENTO AUTOMÁTICO">
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                ...
                <span style={{ color: dados.agendamentoAutomatico === 'Ativado' ? '#10b981' : '#64748b', fontSize: '0.85rem', fontWeight: 600 }}>
                  Status: {dados.agendamentoAutomatico === 'Ativado' ? 'Ativado ✓' : 'Desativado'}
                </span>
              </div>
            </GeralCampoGlobal>
          </div>
          ...
          <div className="em-grid">
            <GeralCampoGlobal label="TIPOS DE TESTE ATIVOS (AGENDAMENTO)">
              <div style={{ 
                display: 'flex', 
                alignItems: 'center',
                gap: '1.5rem', 
          ...
          <div className="em-grid" style={{ width: '50%' }}>
            <GeralCampoGlobal label="AMBIENTE ALVO">
              <SelectGlobal
      ...
      conteudo: (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', padding: '1.5rem' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.5rem' }}>
            ...
            >
              {mostrarFormAlerta ? 'Cancelar' : '+ Novo Alerta'}
            </button>
          </div>
          ...
          {mostrarFormAlerta && (
            <div style={{ 
              ...
              <GeralCampoGlobal label="NOME DO RECEPTOR">
                <input 
              ...
              <GeralCampoGlobal label="CONTATO (EMAIL/TEL)">
                <input 
                  className="ws-input-pure"
              ...
              <GeralCampoGlobal label="CONDIÇÃO">
                <SelectGlobal 
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', padding: '1.5rem' }}>
          ...
          <div style={{ background: 'rgba(15, 23, 42, 0.3)', border: '1px solid rgba(255, 255, 255, 0.05)', borderRadius: '16px', padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '2rem' }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '3rem' }}>
              <GeralCampoGlobal label="SELECIONE OS TIPOS">
              ...
              <GeralCampoGlobal label="AMBIENTE DE ORIGEM">
                <div style={{ width: '100%' }}>
                  <SelectGlobal
                    opcoes={opcoesAmbiente}
            ...
            >
              <Play size={20} weight="fill" /> Executar Agora
            </button>
          </div>
        </div>
      )
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', padding: '1.5rem' }}>
          ...
          <div className="em-grid em-grid--2">
            <div style={{ background: 'rgba(30, 41, 59, 0.5)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '12px', padding: '1.25rem' }}>
              <span style={{ display: 'block', fontSize: '0.7rem', fontWeight: 700, color: '#64748b', textTransform: 'uppercase', marginBottom: '0.5rem' }}>Próxima Execução</span>
              <span style={{ color: '#f1f5f9', fontSize: '1.25rem', fontWeight: 300 }}>Aguardando Gatilho...</span>
            </div>
            <div style={{ background: 'rgba(30, 41, 59, 0.5)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '12px', padding: '1.25rem' }}>
              <span style={{ display: 'block', fontSize: '0.7rem', fontWeight: 700, color: '#64748b', textTransform: 'uppercase', marginBottom: '0.5rem' }}>Frequência Cron</span>
          ...
          <div style={{ background: 'rgba(15, 23, 42, 0.2)', border: '1px dashed rgba(255,255,255,0.1)', borderRadius: '16px', padding: '2rem', textAlign: 'center' }}>
            ...
            <p style={{ color: '#94a3b8', fontSize: '0.9rem' }}>Ainda não há execuções automáticas registradas para este ambiente.</p>
          </div>
        </div>
      )
    }
    ...
    <ModalFormularioAbasGlobal
      ...
      titulo={
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          <span>Agendamento de Testes</span>
          <span style={{
            fontSize: '0.625rem',
            fontWeight: 800,
      ...
      subtitulo="Configuração central de rotinas de QA e pipelines CI/CD"
      dirty={isDirty}
      podesSalvar={isDirty}
      tamanho="lg"
      altura="720px"
