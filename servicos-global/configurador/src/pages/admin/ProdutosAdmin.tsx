  ...
  const ACOES_PRODUTOS: TabelaGlobalAcao<ProdutoCatalogo>[] = [
    {
      ...
      renderCustom: (item) => (
        <TooltipGlobal descricao={item.status === 'Ativo' ? 'Suspender produto' : 'Ativar produto'}>
          <button
            type="button"
    ...
    },
    {
      ...
      renderCustom: (item) => (
        <TooltipGlobal descricao="Editar produto">
          <button
            type="button"
    ...
    },
    {
      ...
      renderCustom: (item) => (
        <TooltipGlobal descricao="Excluir produto">
          <button
            type="button"
