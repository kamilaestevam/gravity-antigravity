...
const PILARES: PilarCustomizacao[] = [
  {
    ...
    descricao: 'Desmarque campos de **cotação** ou **BID** que não quer ver na tabela.',
    icone: EyeSlash,
    cor: '#f87171',
...
/** Manual BID Frete § Lista — mapa da customização da Lista */
export function ManualInfograficoBidFreteListaCustomizacao() {
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ minWidth: 0 }}>
          ...
          <p style={{
            ...
            A Lista do BID Frete se adapta ao seu jeito de trabalhar
          </p>
          <p style={{
            margin: '8px 0 0',
            fontSize: '.74rem',
