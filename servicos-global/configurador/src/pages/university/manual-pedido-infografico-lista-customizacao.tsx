...
const PILARES: PilarCustomizacao[] = [
  {
    ...
    descricao: 'Desmarque campos de **pedido** ou **item** que não quer ver na tabela.',
    icone: EyeSlash,
    cor: '#f87171',
  ...
  },
  {
    ...
    descricao: 'Marque de volta colunas do catálogo do PO. A lista atualiza na hora.',
    icone: Eye,
    cor: '#34d399',
  ...
  },
  {
    ...
    descricao: 'Monte campos próprios (**texto**, **número**, **data**, **fórmula**). Fluxo completo em **Configurações**.',
    icone: PlusCircle,
    cor: '#a78bfa',
      ...
      <div style={{
        ...
        <div style={{ minWidth: 0 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
            <Columns size={18} weight="duotone" color="#f59e0b" />
            <span style={{
              display: 'inline-flex',
              alignItems: 'center',
              gap: 5,
          ...
          <p style={{
            ...
            A Lista do Pedido se adapta ao seu jeito de trabalhar
          </p>
          <p style={{
            margin: '8px 0 0',
            fontSize: '.74rem',
            ...
            Quatro ações no menu <strong style={{ color: '#cbd5e1' }}>Colunas</strong> montam a visualização ideal: campos nativos de pedido e item ou colunas próprias.
          </p>
        </div>
      </div>
