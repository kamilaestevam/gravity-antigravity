    ...
    itens: [
      {
        ...
        icone: Layout,
        capitulos: [{ num: 9, rotulo: 'Painéis' }],
        imagem: IMG.paineis,
  ...
  },
  {
    ...
    itens: [
      ...
      },
      {
        ...
        icone: Trash,
        capitulos: [{ num: 7, rotulo: 'Excluir' }],
      ...
      },
      {
        ...
        icone: Columns,
        capitulos: [{ num: 4, rotulo: 'Customizar' }],
        imagem: IMG.colunas,
      ...
      },
      {
        ...
        icone: Export,
        capitulos: [{ num: 8, rotulo: 'Exportar' }],
        imagem: IMG.lista,
