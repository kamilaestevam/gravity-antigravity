...
export function ModalEditarEmpresa({ empresa, idOrganizacao, aoFechar, aoSalvar }: Props) {
  ...
  const podeSalvar =
    form.nome_empresa.trim().length >= 2 &&
    /^[A-Z]{2}$/.test(form.pais.trim().toUpperCase()) &&
    (!ehBr || form.cnpj.trim().length > 0) &&
    algumaFlagAtiva &&
    !enviando
          ...
          <GeralCampoGlobal label="RAZÃO SOCIAL" obrigatorio>
            <div className="ws-input-icon-wrap">
              ...
              <input
                ...
                style={{ width: '100%', borderColor: erro('nome_empresa') ? corErro : undefined }}
              />
            </div>
          ...
          <GeralCampoGlobal label="PAÍS (ISO-2)" obrigatorio>
            <div className="ws-input-icon-wrap">
              ...
              <input
                ...
                placeholder="BR"
                maxLength={2}
                style={{ width: '100%', textTransform: 'uppercase', borderColor: erro('pais') ? corErro : undefined }}
              />
            </div>
          ...
          <GeralCampoGlobal label="CNPJ" obrigatorio>
            <div className="ws-input-icon-wrap">
              ...
              <input
                ...
                style={{ width: '100%', borderColor: erro('cnpj') ? corErro : undefined }}
              />
            </div>
