/**
 * TabelaWorkspaces — filtros inline por coluna com valores da coluna (estilo Excel).
...
interface TabelaWorkspacesProps {
  dados: Empresa[]
...
export function TabelaWorkspaces({ dados, onSuspender, onExcluir }: TabelaWorkspacesProps) {
  ...
  const chips = useMemo(() => {
    ...
    filtros.nome.forEach(v => list.push({ key: `nome-${v}`, label: `Workspace: ${v}`, onRemover: () => onToggleValor('nome', v) }))
