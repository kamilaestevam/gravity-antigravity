...
import { correlationMiddleware }       from '@organizacao/middleware/correlation.js'
import { authMiddleware }              from '@organizacao/middleware/auth.js'
import { withInternalKeyValidation }   from '@organizacao/middleware/withInternalKeyValidation.js'
import { errorHandler }                from '@organizacao/middleware/errorHandler.js'
import { prisma }                      from './lib/prisma.js'

// ── Routers dos serviços ──────────────────────────────────────────────────────
import { atividadesServiceRouter }  from '@organizacao/atividades/server/routes.js'
import { cronometroServiceRouter }  from '@organizacao/cronometro/server/routes.js'
import { emailServiceRouter }       from '@organizacao/email/server/routes.js'
import { gabiServiceRouter }        from '@organizacao/gabi/server/routes.js'
import { dashboardServiceRouter }   from '@organizacao/dashboard/server/routes.js'
import { relatoriosServiceRouter }  from '@organizacao/relatorios/server/routes.js'
import { historicoServiceRouter }   from '@organizacao/historico-global/server/routes.js'
import { notificacoesServiceRouter } from '@organizacao/notificacoes/server/routes.js'
import { agendamentoServiceRouter } from '@organizacao/agendamento/server/routes.js'
import { preferenciasServiceRouter } from '@organizacao/preferencias-usuario/server/routes.js'
import { whatsappServiceRouter }    from '@organizacao/whatsapp/server/routes.js'
import { ncmSyncServiceRouter }     from '@organizacao/ncm-sync/server/routes.js'

// ── Inicializações assíncronas ────────────────────────────────────────────────
import { initHistorico }     from '@organizacao/historico-global/server/init.js'
import { initNotificacoes }  from '@organizacao/notificacoes/server/init.js'
import { initNcmSync }       from '@organizacao/ncm-sync/server/init.js'
