...
export const PRODUCT_CONFIG = {
  ...
  navigation: [
    ...
    { id: '/bid-cambio/visao-geral',               label: 'Visão Geral',    icon: 'chart-pie-slice',          source: 'product' },
    { id: '/bid-cambio/dashboard',                 label: 'Dashboard',      icon: 'chart-bar',                source: 'product' },
    { id: '/bid-cambio/lista',                     label: 'Lista',          icon: 'list-bullets',             source: 'product' },
    { id: '/bid-cambio/kanban',                    label: 'Kanban',         icon: 'kanban',                   source: 'product' },
    { id: '/bid-cambio/cambios',                   label: 'Câmbios',        icon: 'file-text',                source: 'product' },
    { id: '/bid-cambio/cotacoes',                  label: 'Cotações',       icon: 'arrows-left-right',        source: 'product' },
    { id: '/bid-cambio/corretoras',                label: 'Corretoras',     icon: 'buildings',                source: 'product' },
    ...
    { id: '/bid-cambio/configuracoes', label: 'Configurações', icon: 'gear-six', source: 'product' },
