...
export function DashboardAdicionarWidgetBotao({
  ...
  const painel = open && typeof document !== 'undefined'
    ? createPortal(
        <div
          ref={painelRef}
          className="bid-frete-dashboard-toolbar-icon-dropdown__painel bid-frete-dashboard-toolbar-icon-dropdown__painel--portal bid-frete-dashboard-adicionar-widget__painel"
        ...
        >
          <button
            type="button"
            role="menuitem"
            className="bid-frete-dashboard-toolbar-icon-dropdown__opcao bid-frete-dashboard-adicionar-widget__opcao"
            data-testid="btn-adicionar-sugestoes"
            onClick={() => { fechar(); onAbrirSugestoes() }}
          >
            <ChartBar size={14} weight="duotone" aria-hidden="true" />
            <span className="bid-frete-dashboard-adicionar-widget__texto">
              <span className="bid-frete-dashboard-adicionar-widget__titulo">
                {t('nucleo.dashboard.sugestoes.titulo')}
              </span>
              <span className="bid-frete-dashboard-adicionar-widget__descricao">
