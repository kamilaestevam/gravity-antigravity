                ...
                {editando ? (
                  <div className="bf-contato-email-edicao">
                    ...
                    <div className="bf-contato-email-edicao-acoes">
                      <button type="button" onClick={() => { setEmailEditando(null); setErro(null) }} disabled={salvando}>
        ...
        {!cadastroRapido ? (
          ...
          <div className="bf-contato-email-rapido">
            ...
            <div className="bf-contato-email-rapido-acoes">
              <button type="button" onClick={() => { setCadastroRapido(false); setErro(null) }} disabled={salvando}>
                {t('comum.cancelar', 'Cancelar')}
              </button>
...
function ContatoEmailStyles() {
  return (
    <style>{`
      ...
      .bf-contato-email-edicao input, .bf-contato-email-rapido input {
      ...
      .bf-contato-email-edicao-acoes, .bf-contato-email-rapido-acoes { display: flex; justify-content: flex-end; gap: 0.5rem; }
