...
function OptionButton({ selected, onClick, icon, label, description, }) {
    return (_jsxs("button", { type: "button", className: `nc-option-btn ${selected ? 'nc-option-btn--selected' : ''}`, onClick: onClick, children: [_jsx("div", { className: "nc-option-checkbox", children: selected && _jsx("span", { className: "nc-option-checkmark", children: "\u2713" }) }), _jsx("span", { className: "nc-option-icon", children: icon }), _jsxs("div", { className: "nc-option-text", children: [_jsx("span", { className: "nc-option-label", children: label }), description && _jsx("span", { className: "nc-option-desc", children: description })] })] }));
}
// ─── Input Field ─────────────────────────────────────────────────────────────
...
export default function NovaCotacao() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const cotacao = await criarCotacao({
                tipo_operacao_cotacao_bid_frete_internacional: form.tipo_operacao_cotacao_bid_frete_internacional,
                modal_cotacao_bid_frete_internacional: form.modal_cotacao_bid_frete_internacional,
                modalidade_cotacao_bid_frete_internacional: form.modalidade_cotacao_bid_frete_internacional,
                origem_codigo_cotacao_bid_frete_internacional: form.origem_codigo_cotacao_bid_frete_internacional,
                origem_nome_cotacao_bid_frete_internacional: form.origem_nome_cotacao_bid_frete_internacional,
                ...
                destino_nome_cotacao_bid_frete_internacional: form.destino_nome_cotacao_bid_frete_internacional,
    ...
    const renderStep = () => {
        switch (step) {
            ...
            case 1:
                return (_jsxs("div", { className: "nc-step-content", children: [_jsx("h3", { className: "nc-section-title", children: t('bidfrete.nova_cotacao.tipo_operacao') }), _jsx("div", { className: "nc-options-grid-2", children: ['IMPORTACAO', 'EXPORTACAO'].map(op => (_jsx(OptionButton, { selected: form.tipo_operacao_cotacao_bid_frete_internacional === op, onClick: () => {
                                    set('tipo_operacao_cotacao_bid_frete_internacional', op);
                                }, icon: op === 'IMPORTACAO' ? _jsx(ArrowLeft, { weight: "duotone", size: 24 }) : _jsx(ArrowRight, { weight: "duotone", size: 24 }), label: OPERACAO_LABELS[op], description: OPERACAO_DESCS[op] }, op))) }), _jsx("h3", { className: "nc-section-title", children: t('bidfrete.nova_cotacao.modal_frete') }), _jsxs("div", { className: "nc-options-grid-3", children: [_jsx(OptionButton, { selected: form.modal_cotacao_bid_frete_internacional === 'MARITIMO', onClick: () => {
                                    ...
                                    }, icon: _jsx(Anchor, { weight: "duotone", size: 28 }), label: "Mar\u00EDtimo", description: MODAL_DESCS.MARITIMO }), _jsx(OptionButton, { selected: form.modal_cotacao_bid_frete_internacional === 'AEREO', onClick: () => {
                                        set('modal_cotacao_bid_frete_internacional', 'AEREO');
                                        set('modalidade_cotacao_bid_frete_internacional', '');
                                    }, icon: _jsx(AirplaneTilt, { weight: "duotone", size: 28 }), label: "A\u00E9reo", description: MODAL_DESCS.AEREO }), _jsx(OptionButton, { selected: form.modal_cotacao_bid_frete_internacional === 'RODOVIARIO', onClick: () => {
                                        set('modal_cotacao_bid_frete_internacional', 'RODOVIARIO');
                                        set('modalidade_cotacao_bid_frete_internacional', '');
                                    }, icon: _jsx(Van, { weight: "duotone", size: 28 }), label: "Rodovi\u00E1rio", description: MODAL_DESCS.RODOVIARIO })] }), _jsx("h3", { className: "nc-section-title", children: t('bidfrete.nova_cotacao.modalidade') }), _jsxs("div", { className: "nc-options-grid-2", children: [form.modal_cotacao_bid_frete_internacional === 'MARITIMO' && (_jsxs(_Fragment, { children: [_jsx(OptionButton, { selected: form.modalidade_cotacao_bid_frete_internacional === 'FCL', onClick: () => set('modalidade_cotacao_bid_frete_internacional', 'FCL'), icon: _jsx(Package, { weight: "duotone", size: 22 }), label: "FCL \u2014 Container Completo", description: MODALIDADE_DESCS.FCL }), _jsx(OptionButton, { selected: form.modalidade_cotacao_bid_frete_internacional === 'LCL', onClick: () => set('modalidade_cotacao_bid_frete_internacional', 'LCL'), icon: _jsx(Package, { weight: "duotone", size: 22 }), label: "LCL \u2014 Carga Fracionada", description: MODALIDADE_DESCS.LCL })] })), form.modal_cotacao_bid_frete_internacional === 'AEREO' && (_jsx("div", { style: { gridColumn: 'span 2' }, children: _jsx(OptionButton, { selected: form.modalidade_cotacao_bid_frete_internacional === 'AEREO_GERAL', onClick: () => set('modalidade_cotacao_bid_frete_internacional', 'AEREO_GERAL'), icon: _jsx(AirplaneTilt, { weight: "duotone", size: 22 }), label: "A\u00E9reo Geral", description: MODALIDADE_DESCS.AEREO_GERAL }) })), form.modal_cotacao_bid_frete_internacional === 'RODOVIARIO' && (_jsxs(_Fragment, { children: [_jsx(OptionButton, { selected: form.modalidade_cotacao_bid_frete_internacional === 'RODOVIARIO_FTL', onClick: () => set('modalidade_cotacao_bid_frete_internacional', 'RODOVIARIO_FTL'), icon: _jsx(Van, { weight: "duotone", size: 22 }), label: "FTL \u2014 Carga Completa", description: MODALIDADE_DESCS.RODOVIARIO_FTL }), _jsx(OptionButton, { selected: form.modalidade_cotacao_bid_frete_internacional === 'RODOVIARIO_LTL', onClick: () => set('modalidade_cotacao_bid_frete_internacional', 'RODOVIARIO_LTL'), icon: _jsx(Van, { weight: "duotone", size: 22 }), label: "LTL \u2014 Carga Fracionada", description: MODALIDADE_DESCS.RODOVIARIO_LTL })] })), !form.modal_cotacao_bid_frete_internacional && (_jsxs("div", { className: "nc-empty-hint", children: [_jsx(Info, { size: 18, weight: "duotone" }), _jsx("p", { children: t('bidfrete.nova_cotacao.selecionar_modal_primeiro') })] }))] })] }));
            // STEP 2 — Origem
            case 2:
                return (_jsx("div", { className: "nc-step-content", children: _jsxs("div", { className: "nc-location-visual-card nc-location-visual-card--origin", children: [_jsxs("div", { className: "nc-location-visual-header", children: [_jsx("div", { className: "nc-location-visual-circle", children: _jsx(MapPin, { weight: "duotone", size: 26, className: "nc-pulsing-icon" }) }), _jsxs("div", { className: "nc-location-visual-text", children: [_jsx("h4", { children: t('bidfrete.nova_cotacao.porto_origem') }), _jsx("p", { children: "Informe o local de coleta ou porto de origem de partida internacional." })] })] }), _jsxs("div", { className: "nc-fields-grid nc-fields-grid--location", children: [_jsx(Field, { label: t('bidfrete.nova_cotacao.codigo_locode'), required: true, children: _jsx("input", { className: "nc-input", placeholder: "Ex: CNSHA", value: form.origem_codigo_cotacao_bid_frete_internacional, onChange: e => set('origem_codigo_cotacao_bid_frete_internacional', e.target.value.toUpperCase()) }) }), _jsx(Field, { label: t('bidfrete.nova_cotacao.nome'), required: true, children: _jsx("input", { className: "nc-input", placeholder: "Ex: Shanghai", value: form.origem_nome_cotacao_bid_frete_internacional, onChange: e => set('origem_nome_cotacao_bid_frete_internacional', e.target.value) }) }), _jsx(Field, { label: t('bidfrete.nova_cotacao.pais'), required: true, children: _jsx("input", { className: "nc-input", placeholder: "Ex: China", value: form.origem_pais_cotacao_bid_frete_internacional, onChange: e => set('origem_pais_cotacao_bid_frete_internacional', e.target.value) }) })] })] }) }));
            // STEP 3 — Destino
            case 3:
                return (_jsx("div", { className: "nc-step-content", children: _jsxs("div", { className: "nc-location-visual-card nc-location-visual-card--destination", children: [_jsxs("div", { className: "nc-location-visual-header", children: [_jsx("div", { className: "nc-location-visual-circle", children: _jsx(MapPin, { weight: "duotone", size: 26, className: "nc-pulsing-icon-dest" }) }), _jsxs("div", { className: "nc-location-visual-text", children: [_jsx("h4", { children: t('bidfrete.nova_cotacao.porto_destino') }), _jsx("p", { children: "Defina o local de entrega final ou porto de destino de chegada." })] })] }), _jsxs("div", { className: "nc-fields-grid nc-fields-grid--location", children: [_jsx(Field, { label: t('bidfrete.nova_cotacao.codigo_locode'), required: true, children: _jsx("input", { className: "nc-input", placeholder: "Ex: BRSSZ", value: form.destino_codigo_cotacao_bid_frete_internacional, onChange: e => set('destino_codigo_cotacao_bid_frete_internacional', e.target.value.toUpperCase()) }) }), _jsx(Field, { label: t('bidfrete.nova_cotacao.nome'), required: true, children: _jsx("input", { className: "nc-input", placeholder: "Ex: Santos", value: form.destino_nome_cotacao_bid_frete_internacional, onChange: e => set('destino_nome_cotacao_bid_frete_internacional', e.target.value) }) }), _jsx(Field, { label: t('bidfrete.nova_cotacao.pais'), required: true, children: _jsx("input", { className: "nc-input", placeholder: "Ex: Brasil", value: form.destino_pais_cotacao_bid_frete_internacional, onChange: e => set('destino_pais_cotacao_bid_frete_internacional', e.target.value) }) })] })] }) }));
            // STEP 4 — Carga
            case 4:
                return (_jsxs("div", { className: "nc-step-content", children: [_jsx("h3", { className: "nc-section-title", children: t('bidfrete.nova_cotacao.dados_mercadoria') }), _jsxs("div", { className: "nc-fields-grid nc-fields-grid--cargo", children: [_jsx("div", { style: { gridColumn: 'span 2' }, children: _jsx(Field, { label: t('bidfrete.nova_cotacao.descricao_mercadoria'), required: true, children: _jsx("input", { className: "nc-input", placeholder: "Ex: Pe\u00E7as automotivas, eletr\u00F4nicos industriais...", value: form.descricao_mercadoria_cotacao_bid_frete_internacional, onChange: e => set('descricao_mercadoria_cotacao_bid_frete_internacional', e.target.value) }) }) }), _jsx(Field, { label: t('bidfrete.nova_cotacao.ncm'), children: _jsx("input", { className: "nc-input", placeholder: "Ex: 87089990", value: form.ncm_cotacao_bid_frete_internacional, onChange: e => set('ncm_cotacao_bid_frete_internacional', e.target.value.replace(/\D/g, '').slice(0, 8)) }) }), _jsx(Field, { label: t('bidfrete.nova_cotacao.quantidade'), required: true, children: _jsxs("div", { className: "nc-input-group", children: [_jsx("input", { className: "nc-input nc-input--with-suffix", type: "number", min: 1, value: form.quantidade_cotacao_bid_frete_internacional, onChange: e => set('quantidade_cotacao_bid_frete_internacional', parseInt(e.target.value) || 1) }), _jsx("span", { className: "nc-input-suffix", children: "un" })] }) }), form.modal_cotacao_bid_frete_internacional === 'MARITIMO' && (_jsx(Field, { label: t('bidfrete.nova_cotacao.tipo_container'), children: _jsx("input", { className: "nc-input", placeholder: "Ex: 40' HC", value: form.tipo_container_cotacao_bid_frete_internacional, onChange: e => set('tipo_container_cotacao_bid_frete_internacional', e.target.value) }) })), _jsx(Field, { label: t('bidfrete.nova_cotacao.peso_kg'), children: _jsxs("div", { className: "nc-input-group", children: [_jsx("input", { className: "nc-input nc-input--with-suffix", type: "number", placeholder: "Ex: 12000", value: form.peso_kg_cotacao_bid_frete_internacional, onChange: e => set('peso_kg_cotacao_bid_frete_internacional', e.target.value) }), _jsx("span", { className: "nc-input-suffix", children: "Kg" })] }) }), _jsx(Field, { label: t('bidfrete.nova_cotacao.cubagem_m3'), children: _jsxs("div", { className: "nc-input-group", children: [_jsx("input", { className: "nc-input nc-input--with-suffix", type: "number", placeholder: "Ex: 33.2", value: form.cubagem_m3_cotacao_bid_frete_internacional, onChange: e => set('cubagem_m3_cotacao_bid_frete_internacional', e.target.value) }), _jsx("span", { className: "nc-input-suffix", children: "m\u00B3" })] }) })] })] }));
            // STEP 5 — Incoterm
            case 5: {
                ...
                return (_jsxs("div", { className: "nc-step-content", children: [_jsx("h3", { className: "nc-section-title", children: t('bidfrete.nova_cotacao.incoterm') }), _jsx("div", { className: "nc-incoterm_cotacao_bid_frete_internacional-grid", children: INCOTERMS.map(inc => (_jsx("button", { type: "button", className: `nc-incoterm_cotacao_bid_frete_internacional-btn ${form.incoterm_cotacao_bid_frete_internacional === inc ? 'nc-incoterm_cotacao_bid_frete_internacional-btn--selected' : ''}`, onClick: () => set('incoterm_cotacao_bid_frete_internacional', inc), children: inc }, inc))) }), explanation && (_jsxs("div", { className: "nc-incoterm_cotacao_bid_frete_internacional-helper-card nc-fade-in", children: [_jsxs("div", { className: "nc-helper-header", children: [_jsx(Scales, { size: 20, weight: "duotone", className: "nc-helper-icon" }), _jsx("h4", { children: explanation.title })] }), _jsx("p", { className: "nc-helper-desc", children: explanation.desc }), _jsxs("div", { className: "nc-helper-footer", children: [_jsx("strong", { children: "Responsabilidade:" }), " ", explanation.responsabilidade] })] })), form.incoterm_cotacao_bid_frete_internacional === 'EXW' && (_jsx("div", { style: { marginTop: '1.25rem' }, className: "nc-fade-in", children: _jsx(Field, { label: t('bidfrete.nova_cotacao.cep_coleta'), required: true, children: _jsx("input", { className: "nc-input", placeholder: "Ex: 01310-100", value: form.cep_destino, onChange: e => set('cep_destino', e.target.value) }) }) })), _jsx("div", { className: "nc-fields-grid", style: { marginTop: '1.5rem' }, children: _jsx(Field, { label: t('bidfrete.nova_cotacao.prazo_respostas'), children: _jsx("input", { className: "nc-input nc-input--date", type: "datetime-local", value: form.prazo_resposta, onChange: e => set('prazo_resposta', e.target.value) }) }) })] }));
            }
            // STEP 6 — Fornecedores
            case 6:
                return (_jsxs("div", { className: "nc-step-content", children: [_jsx("h3", { className: "nc-section-title", children: t('bidfrete.nova_cotacao.visibilidade') }), _jsxs("div", { className: "nc-visibilidade_cotacao_bid_frete_internacional-grid", children: [_jsxs("button", { type: "button", className: `nc-vis-card ${form.visibilidade_cotacao_bid_frete_internacional === 'DIRECIONADA' ? 'nc-vis-card--selected' : ''}`, onClick: () => set('visibilidade_cotacao_bid_frete_internacional', 'DIRECIONADA'), children: [_jsx("div", { className: "nc-vis-icon-wrap", children: _jsx(Users, { weight: "duotone", size: 24 }) }), _jsxs("div", { className: "nc-vis-info", children: [_jsx("span", { className: "nc-vis-title", children: t('bidfrete.nova_cotacao.direcionada_label') }), _jsx("span", { className: "nc-vis-desc", children: t('bidfrete.nova_cotacao.hint_direcionada') })] })] }), _jsxs("button", { type: "button", className: `nc-vis-card ${form.visibilidade_cotacao_bid_frete_internacional === 'ABERTA' ? 'nc-vis-card--selected' : ''}`, onClick: () => set('visibilidade_cotacao_bid_frete_internacional', 'ABERTA'), children: [_jsx("div", { className: "nc-vis-icon-wrap", children: _jsx(Users, { weight: "duotone", size: 24 }) }), _jsxs("div", { className: "nc-vis-info", children: [_jsx("span", { className: "nc-vis-title", children: t('bidfrete.nova_cotacao.aberta_label') }), _jsx("span", { className: "nc-vis-desc", children: t('bidfrete.nova_cotacao.hint_aberta') })] })] })] }), _jsx("div", { className: "nc-switch-row", children: _jsxs("label", { className: "nc-switch-label", children: [_jsxs("div", { className: "nc-switch-text", children: [_jsx("span", { className: "nc-switch-title", children: t('bidfrete.nova_cotacao.anonima_label') }), _jsx("span", { className: "nc-switch-desc", children: "Ocultar o nome da sua empresa no mercado inicial de lances para total confidencialidade." })] }), _jsxs("div", { className: "nc-switch", children: [_jsx("input", { type: "checkbox", checked: form.anonima, onChange: e => set('anonima', e.target.checked) }), _jsx("span", { className: "nc-switch-slider" })] })] }) })] }));
            // STEP 7 — Resumo
            case 7:
                return (_jsxs("div", { className: "nc-step-content", children: [_jsx("h3", { className: "nc-section-title", children: t('bidfrete.nova_cotacao.resumo_cotacao') }), _jsxs("div", { className: "nc-fields-grid nc-fields-grid--summary-inputs", children: [_jsx(Field, { label: t('bidfrete.nova_cotacao.valor_alvo'), children: _jsx("input", { className: "nc-input", type: "number", placeholder: "Ex: 5000", value: form.valor_alvo, onChange: e => set('valor_alvo', e.target.value) }) }), _jsx(Field, { label: t('bidfrete.nova_cotacao.moeda'), children: _jsxs("select", { className: "nc-input", value: form.moeda_alvo, onChange: e => set('moeda_alvo', e.target.value), children: [_jsx("option", { value: "USD", children: "USD ($)" }), _jsx("option", { value: "BRL", children: "BRL (R$)" }), _jsx("option", { value: "EUR", children: "EUR (\u20AC)" })] }) })] }), _jsxs("div", { className: "nc-receipt-card", children: [_jsxs("div", { className: "nc-receipt-header", children: [_jsx("span", { className: "nc-receipt-badge", children: form.tipo_operacao_cotacao_bid_frete_internacional ? OPERACAO_LABELS[form.tipo_operacao_cotacao_bid_frete_internacional] : '—' }), _jsxs("span", { className: "nc-receipt-modal_cotacao_bid_frete_internacional", children: [form.modal_cotacao_bid_frete_internacional ? MODAL_LABELS[form.modal_cotacao_bid_frete_internacional] : '—', " / ", form.modalidade_cotacao_bid_frete_internacional ? MODALIDADE_LABELS[form.modalidade_cotacao_bid_frete_internacional] : '—'] })] }), _jsxs("div", { className: "nc-route-timeline", children: [_jsxs("div", { className: "nc-timeline-node", children: [_jsx("div", { className: "nc-node-dot nc-node-dot--origin" }), _jsxs("div", { className: "nc-node-text", children: [_jsx("span", { className: "nc-node-code", children: form.origem_codigo_cotacao_bid_frete_internacional || '—' }), _jsxs("span", { className: "nc-node-name", children: [form.origem_nome_cotacao_bid_frete_internacional || '—', form.origem_pais_cotacao_bid_frete_internacional ? `, ${form.origem_pais_cotacao_bid_frete_internacional}` : ''] })] })] }), _jsxs("div", { className: "nc-timeline-line", children: [_jsxs("div", { className: "nc-timeline-icon-wrap", children: [form.modal_cotacao_bid_frete_internacional === 'MARITIMO' && _jsx(Anchor, { weight: "duotone", size: 16 }), form.modal_cotacao_bid_frete_internacional === 'AEREO' && _jsx(AirplaneTilt, { weight: "duotone", size: 16 }), form.modal_cotacao_bid_frete_internacional === 'RODOVIARIO' && _jsx(Van, { weight: "duotone", size: 16 }), !form.modal_cotacao_bid_frete_internacional && _jsx(Truck, { weight: "duotone", size: 16 })] }), _jsx("div", { className: "nc-timeline-line-fill" })] }), _jsxs("div", { className: "nc-timeline-node", children: [_jsx("div", { className: "nc-node-dot nc-node-dot--destination" }), _jsxs("div", { className: "nc-node-text", children: [_jsx("span", { className: "nc-node-code", children: form.destino_codigo_cotacao_bid_frete_internacional || '—' }), _jsxs("span", { className: "nc-node-name", children: [form.destino_nome_cotacao_bid_frete_internacional || '—', form.destino_pais_cotacao_bid_frete_internacional ? `, ${form.destino_pais_cotacao_bid_frete_internacional}` : ''] })] })] })] }), _jsxs("div", { className: "nc-receipt-details", children: [_jsxs("div", { className: "nc-receipt-row", children: [_jsx("span", { className: "nc-receipt-label", children: t('bidfrete.nova_cotacao.resumo_mercadoria') }), _jsx("span", { className: "nc-receipt-value", children: form.descricao_mercadoria_cotacao_bid_frete_internacional || '—' })] }), form.ncm_cotacao_bid_frete_internacional && (_jsxs("div", { className: "nc-receipt-row", children: [_jsx("span", { className: "nc-receipt-label", children: t('bidfrete.nova_cotacao.resumo_ncm') }), _jsx("span", { className: "nc-receipt-value font-mono", children: form.ncm_cotacao_bid_frete_internacional })] })), _jsxs("div", { className: "nc-receipt-row", children: [_jsx("span", { className: "nc-receipt-label", children: t('bidfrete.nova_cotacao.resumo_qtd_peso') }), _jsxs("span", { className: "nc-receipt-value", children: [form.quantidade_cotacao_bid_frete_internacional, " un ", form.peso_kg_cotacao_bid_frete_internacional ? `| ${form.peso_kg_cotacao_bid_frete_internacional} Kg` : '', " ", form.cubagem_m3_cotacao_bid_frete_internacional ? `| ${form.cubagem_m3_cotacao_bid_frete_internacional} m³` : ''] })] }), _jsxs("div", { className: "nc-receipt-row", children: [_jsx("span", { className: "nc-receipt-label", children: t('bidfrete.nova_cotacao.resumo_incoterm') }), _jsx("span", { className: "nc-receipt-value nc-receipt-value--incoterm_cotacao_bid_frete_internacional", children: form.incoterm_cotacao_bid_frete_internacional || '—' })] }), _jsxs("div", { className: "nc-receipt-row", children: [_jsx("span", { className: "nc-receipt-label", children: t('bidfrete.nova_cotacao.resumo_visibilidade') }), _jsxs("span", { className: "nc-receipt-value", children: [form.visibilidade_cotacao_bid_frete_internacional === 'ABERTA' ? 'Aberta' : 'Direcionada', form.anonima ? ' (Anônima)' : ''] })] })] })] })] }));
            default:
                return null;
        }
    };
    ...
    // ─── Render principal ──────────────────────────────────────────────────
    return (_jsxs("div", { className: "nc-modal_cotacao_bid_frete_internacional-overlay", onClick: handleOverlayClick, children: [_jsxs("div", { className: "nc-modal_cotacao_bid_frete_internacional-container nc-fade-in", onClick: e => e.stopPropagation(), children: [_jsxs("div", { className: "nc-modal_cotacao_bid_frete_internacional-header", children: [_jsxs("div", { className: "nc-modal_cotacao_bid_frete_internacional-header-left", children: [_jsx("div", { className: "nc-modal_cotacao_bid_frete_internacional-header-icon-wrap", children: _jsx(Truck, { weight: "duotone", size: 22 }) }), _jsxs("div", { children: [_jsx("h2", { className: "nc-modal_cotacao_bid_frete_internacional-title", children: "Nova Cota\u00E7\u00E3o" }), _jsx("p", { className: "nc-modal_cotacao_bid_frete_internacional-subtitle", children: "Preencha as informa\u00E7\u00F5es para buscar as melhores op\u00E7\u00F5es de frete" })] })] }), _jsxs("div", { className: "nc-modal_cotacao_bid_frete_internacional-header-step-badge", children: ["Etapa ", step, " de 7 \u2022 ", _jsx("span", { className: "nc-modal_cotacao_bid_frete_internacional-header-step-name", children: STEPS[step - 1].label })] }), _jsx("button", { className: "nc-modal_cotacao_bid_frete_internacional-close", onClick: () => navigate('/cotacoes'), "aria-label": "Fechar", children: _jsx(X, { weight: "bold", size: 20 }) })] }), _jsx("div", { className: "nc-stepper-container", children: _jsx("div", { className: "mpg-stepper", role: "list", "aria-label": "Passos", children: STEPS.map((passo, idx) => {
        ...
        /* ── Incoterms ── */
        .nc-incoterm_cotacao_bid_frete_internacional-grid {
          display: flex;
          flex-wrap: wrap;
          gap: 0.75rem;
        ...
        .nc-incoterm_cotacao_bid_frete_internacional-btn {
        ...
        .nc-incoterm_cotacao_bid_frete_internacional-btn:hover {
          border-color: rgba(99, 102, 241, 0.5);
          color: #fff;
          transform: scale(1.05);
        }
        .nc-incoterm_cotacao_bid_frete_internacional-btn--selected {
...
//# sourceMappingURL=cotacao-nova.js.map