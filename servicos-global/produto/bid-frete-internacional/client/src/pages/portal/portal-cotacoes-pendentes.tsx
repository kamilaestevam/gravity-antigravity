  ...
  return (
    ...
    >
              ...
              <div key={bid.id} className="cp-card">
                <div className="cp-card-header">
                  ...
                  <div className="cp-card-meta">
                    <span className="cp-numero_cotacao_bid_frete_internacional">{numero_cotacao_bid_frete_internacional}</span>
                    <span
                ...
                <div className="cp-card-body">
                  ...
                  <div className="cp-info-row">
                    ...
                    <span>{MODAL_LABELS[modal_cotacao_bid_frete_internacional]}</span>
                  </div>
                  <div className="cp-info-row">
                    <span className="cp-info-label">Incoterm</span>
                    <span>{cotacao?.incoterm_cotacao_bid_frete_internacional ?? '—'}</span>
                  </div>
                  <div className="cp-info-row">
      ...
      <style>{`
        ...
        .cp-modal_cotacao_bid_frete_internacional-icon {
          width: 40px;
          height: 40px;
          display: flex;
          align-items: center;
        ...
        .cp-numero_cotacao_bid_frete_internacional {
