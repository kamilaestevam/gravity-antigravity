/**
 * enviarVisaoFornecedorBidFreteInternacionalPropostaPublico.tsx — Formulario Publico de Resposta (sem login)
...
export default function enviarVisaoFornecedorBidFreteInternacionalPropostaPublico() {
  ...
  const carregar = useCallback(async () => {
    ...
    try {
      const disparo = await getVisaoFornecedorBidFreteInternacionalPublicoDisparo(token)
      const cotacaoRaw = disparo.cotacao
      if (!cotacaoRaw) {
        setPageState('invalid')
        return
      }
      setCotacao({
        numero_cotacao_bid_frete_internacional: cotacaoRaw.numero_cotacao_bid_frete_internacional,
        origem_nome_cotacao_bid_frete_internacional: cotacaoRaw.origem_nome_cotacao_bid_frete_internacional,
        destino_nome_cotacao_bid_frete_internacional: cotacaoRaw.destino_nome_cotacao_bid_frete_internacional,
        modal_cotacao_bid_frete_internacional: cotacaoRaw.modal_cotacao_bid_frete_internacional,
        incoterm_cotacao_bid_frete_internacional: cotacaoRaw.incoterm_cotacao_bid_frete_internacional,
        descricao_mercadoria_cotacao_bid_frete_internacional: cotacaoRaw.descricao_mercadoria_cotacao_bid_frete_internacional,
        quantidade_cotacao_bid_frete_internacional: cotacaoRaw.quantidade_cotacao_bid_frete_internacional,
        peso_kg_cotacao_bid_frete_internacional: cotacaoRaw.peso_kg_cotacao_bid_frete_internacional,
        fornecedor_nome: disparo.fornecedor?.nome_fornecedor_bid_frete_internacional ?? '',
      })
      setPageState('form')
    } catch {
      setPageState('invalid')
