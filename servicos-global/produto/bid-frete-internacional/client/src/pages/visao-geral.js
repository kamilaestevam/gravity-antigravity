...
function VisaoGeralMapa({ onOpenCompleto }) {
    ...
    return (_jsxs("div", { className: "bfd-card bfd-map-card bfd-card--accent-amber", children: [_jsxs("div", { className: "bfd-map-card__header", style: { marginBottom: '0.4rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '0.75rem' }, children: [_jsxs("div", { children: [_jsxs("div", { className: "cg-card__header", style: { marginBottom: '0.4rem' }, children: [_jsx("div", { className: "cg-card__icon-wrap", children: _jsx(Globe, { weight: "duotone", size: 16, style: { color: '#fbbf24' } }) }), _jsx("p", { className: "cg-card__label", style: { margin: 0 }, children: "Vis\u00E3o Geral Global de Cota\u00E7\u00F5es" })] }), _jsx("span", { style: { fontSize: '0.85rem', color: '#cbd5e1', fontWeight: 400, letterSpacing: '0.015em', lineHeight: 1.5 }, children: mapaModo === 'transit'
                            ...
                            backdropFilter: 'blur(8px)',
                                ...
                                return (_jsxs("div", { className: `bfd-map-pin-wrapper ${isHovered ? 'is-active' : ''}`, style: {
                            ...
                            })] }), _jsx("div", { className: "bfd-hud-container", children: mapaModo === 'transit' ? (_jsxs("div", { className: "bfd-map-right-panel bfd-map-right-panel--transit", style: { background: 'rgba(11, 14, 20, 0.45)', border: '1px solid rgba(52, 211, 153, 0.15)', boxShadow: '0 8px 32px 0 rgba(0,0,0,0.5), 0 0 16px rgba(52, 211, 153, 0.08)' }, children: [_jsxs("div", { className: "bfd-map-panel__header", children: [_jsxs("div", { style: { display: 'flex', alignItems: 'center', justifyContent: 'space-between' }, children: [_jsx("span", { className: "bfd-map-panel__title", style: { color: '#34d399', textShadow: '0 0 10px rgba(52, 211, 153, 0.2)' }, children: "Transit Benchmark" }), _jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: '5px' }, children: [_jsx("span", { className: "bfd-map-panel__live-dot", style: { backgroundColor: '#10b981', boxShadow: '0 0 8px #10b981' } }), _jsx("span", { style: { fontSize: '0.62rem', fontWeight: 800, color: '#34d399', textTransform: 'uppercase', letterSpacing: '0.06em' }, children: "ATIVO" })] })] }), _jsx("span", { className: "bfd-map-panel__subtitle", children: "Sua Empresa vs. M\u00E9dia de Mercado" })] }), _jsxs("div", { style: {
                                        ...
                                        fontSize: '0.78rem',
                                        color: '#cbd5e1'
                                    }, children: [_jsxs("div", { style: { display: 'flex', justifyContent: 'space-between', marginBottom: '0.25rem', fontWeight: 700 }, children: [_jsx("span", { children: "Efici\u00EAncia M\u00E9dia Geral" }), _jsx("span", { style: { color: '#34d399' }, children: "+14.2% mais r\u00E1pido" })] }), _jsxs("span", { style: { fontSize: '0.7rem', color: '#94a3b8' }, children: ["Suas rotas ativas est\u00E3o em m\u00E9dia ", _jsx("strong", { children: "3.1 dias" }), " \u00E0 frente do benchmark log\u00EDstico internacional."] })] }), _jsx("div", { className: "bfd-map-panel__list", style: { padding: '0 0.75rem 0.75rem', height: 'calc(100% - 100px)', overflowY: 'auto' }, children: GLOBE_ROUTES.map((route, idx) => {
                                        ...
                                        return (_jsxs("div", { className: `bfd-map-panel__row has-link ${isHighlighted ? 'is-highlighted' : ''}`, style: {
                                                ...
                                                setSelectedPinForDialogoResumido(route.fromId);
                                                            ...
                                                            }, children: [isAir ? _jsx(AirplaneTilt, { size: 9, weight: "bold" }) : _jsx(Anchor, { size: 9, weight: "bold" }), isAir ? 'Aéreo' : 'Marítimo'] })] }), _jsxs("div", { style: { display: 'flex', justifyContent: 'space-between', fontSize: '0.72rem' }, children: [_jsxs("span", { style: { color: '#94a3b8' }, children: ["Sua Empresa: ", _jsxs("strong", { style: { color: '#ffffff' }, children: [tClient, "d"] }), " vs Mercado: ", _jsxs("span", { style: { color: '#cbd5e1' }, children: [tMarket, "d"] })] }), _jsx("span", { style: {
                                                                fontSize: '0.68rem',
                                                                fontWeight: 700,
                                                                color: statusColor,
                                                                padding: '1px 5px',
