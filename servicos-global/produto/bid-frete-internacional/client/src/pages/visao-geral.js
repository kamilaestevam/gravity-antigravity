...
import { MagnifyingGlass, TrendUp, Timer, Anchor, AirplaneTilt, Truck, Trophy, ArrowRight, CaretLeft, CaretRight, Plus, Minus, ArrowCounterClockwise, Play, Pause, Globe, List, MapPin, Clock, CheckCircle, ChatText, Bell, Coins, Funnel, ChartBar, ChartPie, CurrencyDollar, ThumbsUp, Eye, ChartLine, CalendarBlank, } from '@phosphor-icons/react';
...
function VisaoGeralMapa({ onOpenCompleto }) {
                            ...
                            if (pCurrent && pNext) {
                                ...
                                if (pulseDepth >= -0.15) {
                                    ...
                                    if (k === 0) {
                                        ...
                                        if (isMaritime) {
                                            ctx.rect(-2, -1.5, 3, 3);
                                            ctx.fillStyle = coreCol; // core for ship containers
                                        }
                                        else {
                                            ctx.arc(1, 0, 1.5, 0, Math.PI * 2);
                                            ctx.fillStyle = coreCol; // core for plane cockpit
                                        }
                                        ctx.shadowBlur = 0;
                                        ctx.fill();
                                        ctx.restore();
    ...
    return (_jsxs("div", { className: "bfd-card bfd-map-card bfd-card--accent-amber", children: [_jsxs("div", { className: "bfd-map-card__header", style: { marginBottom: '0.4rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '0.75rem' }, children: [_jsxs("div", { children: [_jsxs("div", { className: "cg-card__header", style: { marginBottom: '0.4rem' }, children: [_jsx("div", { className: "cg-card__icon-wrap", children: _jsx(Globe, { weight: "duotone", size: 16, style: { color: '#fbbf24' } }) }), _jsx("p", { className: "cg-card__label", style: { margin: 0 }, children: "Vis\u00E3o Geral Global de Cota\u00E7\u00F5es" })] }), _jsx("span", { style: { fontSize: '0.85rem', color: '#cbd5e1', fontWeight: 400, letterSpacing: '0.015em', lineHeight: 1.5 }, children: mapaModo === 'transit' ? "Benchmarking de Transit Time global (Sua Empresa vs. M\u00E9dia de Mercado)" : "Localiza\u00E7\u00F5es estrat\u00E9gicas, bids ativos e saving acumulado por terminal (Arrastar para Girar)" })] }), _jsxs("div", { style: {
                            display: 'inline-flex',
                            ...
                            backdropFilter: 'blur(8px)',
                        }, children: [_jsxs("button", { onClick: () => setMapaModo('bids'), style: {
                                ...
                                }, children: [_jsx(MapPin, { size: 13, weight: "bold" }), _jsx("span", { children: "Bids Ativos" })] }), _jsxs("button", { onClick: () => setMapaModo('transit'), style: {
                                ...
                                }, children: [_jsx(Clock, { size: 13, weight: "bold" }), _jsx("span", { children: "Transit Time" })] })] })] }), _jsxs("div", { className: "bfd-map-container", children: [_jsxs("div", { className: "bfd-map-canvas-wrapper", onMouseDown: handleMouseDown, onMouseMove: handleMouseMove, onMouseUp: handleMouseUpOrLeave, onMouseLeave: handleMouseUpOrLeave, onTouchStart: handleTouchStart, onTouchMove: handleTouchMove, onTouchEnd: handleMouseUpOrLeave, style: { cursor: isDraggingRef.current ? 'grabbing' : 'grab', userSelect: 'none', touchAction: 'none' }, children: [_jsx("canvas", { ref: canvasRef, style: { width: '100%', height: '100%', display: 'block' } }), _jsx("div", { className: "bfd-map-legend-floating", style: { display: 'flex', flexDirection: 'column', gap: '0.35rem', alignItems: 'flex-start' }, children: mapaModo === 'transit' ? _jsxs(_Fragment, { children: [_jsx("div", { style: { fontSize: '0.68rem', fontWeight: 800, color: '#94a3b8', textTransform: 'uppercase', letterSpacing: '0.04em', marginBottom: '0.15rem' }, children: "Efici\u00EAncia (Cliente vs. Mercado)" }), _jsxs("span", { className: "bfd-map-legend__item", style: { fontSize: '0.72rem', fontWeight: 600 }, children: [_jsx("span", { style: { width: '8px', height: '8px', borderRadius: '50%', backgroundColor: '#34d399', display: 'inline-block', marginRight: '6px', boxShadow: '0 0 6px rgba(52, 211, 153, 0.6)' } }), "Empresa mais r\u00E1pida (Verde)"] }), _jsxs("span", { className: "bfd-map-legend__item", style: { fontSize: '0.72rem', fontWeight: 600 }, children: [_jsx("span", { style: { width: '8px', height: '8px', borderRadius: '50%', backgroundColor: '#fbbf24', display: 'inline-block', marginRight: '6px', boxShadow: '0 0 6px rgba(251, 191, 36, 0.6)' } }), "Dentro do mercado (Amarelo)"] }), _jsxs("span", { className: "bfd-map-legend__item", style: { fontSize: '0.72rem', fontWeight: 600 }, children: [_jsx("span", { style: { width: '8px', height: '8px', borderRadius: '50%', backgroundColor: '#f87171', display: 'inline-block', marginRight: '6px', boxShadow: '0 0 6px rgba(248, 113, 113, 0.6)' } }), "Gargalo / Lenta (Vermelho)"] })] }) : _jsxs(_Fragment, { children: [_jsxs("span", { className: "bfd-map-legend__item", children: [_jsx(Anchor, { size: 15, weight: "bold", style: { color: '#34d399' } }), " Mar\u00EDtimo"] }), _jsxs("span", { className: "bfd-map-legend__item", children: [_jsx(AirplaneTilt, { size: 15, weight: "bold", style: { color: '#a78bfa' } }), " A\u00E9reo"] })] }) }), _jsxs("div", { className: "bfd-map-controls", children: [_jsx("button", { onClick: handleZoomIn, title: "Aumentar Zoom", className: "bfd-map-control-btn", children: _jsx(Plus, { size: 16, weight: "bold" }) }), _jsx("button", { onClick: handleZoomOut, title: "Diminuir Zoom", className: "bfd-map-control-btn", children: _jsx(Minus, { size: 16, weight: "bold" }) }), _jsx("button", { onClick: handleReset, title: "Restaurar Globo", className: "bfd-map-control-btn", children: _jsx(ArrowCounterClockwise, { size: 16, weight: "bold" }) }), _jsx("button", { onClick: toggleRotation, title: isAutoRotating ? "Pausar Rotação" : "Iniciar Rotação", className: "bfd-map-control-btn", children: isAutoRotating ? _jsx(Pause, { size: 16, weight: "bold" }) : _jsx(Play, { size: 16, weight: "bold" }) })] }), projectedPins.map(pin => {
                                if (pin.opacity <= 0.05)
                                    return null;
                ...
                _jsxs("div", { className: "bfd-map-right-panel bfd-map-right-panel--transit", style: { background: 'rgba(11, 14, 20, 0.45)', border: '1px solid rgba(52, 211, 153, 0.15)', boxShadow: '0 8px 32px 0 rgba(0,0,0,0.5), 0 0 16px rgba(52, 211, 153, 0.08)' }, children: [
                    ...
                    _jsxs("div", { style: {
                            ...
                            _jsxs("div", { style: { display: 'flex', justifyContent: 'space-between', marginBottom: '0.25rem', fontWeight: 700 }, children: [
                                _jsx("span", { children: "Efici\u00EAncia M\u00E9dia Geral" }),
                                _jsx("span", { style: { color: '#34d399' }, children: "+14.2% mais r\u00E1pido" })
                            ] }),
                            _jsxs("span", { style: { fontSize: '0.7rem', color: '#94a3b8' }, children: [
                                    "Suas rotas ativas est\u00E3o em m\u00E9dia ",
                                    _jsx("strong", { children: "3.1 dias" }),
                                    " \u00E0 frente do benchmark log\u00EDstico internacional."
                                ] })
                        ] }),
                    _jsx("div", { className: "bfd-map-panel__list", style: { padding: '0 0.75rem 0.75rem', height: 'calc(100% - 100px)', overflowY: 'auto' }, children: GLOBE_ROUTES.map((route, idx) => {
                            ...
                            return (_jsxs("div", { className: `bfd-map-panel__row has-link ${isHighlighted ? 'is-highlighted' : ''}`, style: {
                                    ...
                                    setSelectedPinForModalResumido(route.fromId);
                                                ...
                                                }, children: [isAir ? _jsx(AirplaneTilt, { size: 9, weight: "bold" }) : _jsx(Anchor, { size: 9, weight: "bold" }), isAir ? 'Aéreo' : 'Marítimo'] })] }), _jsxs("div", { style: { display: 'flex', justifyContent: 'space-between', fontSize: '0.72rem' }, children: [_jsxs("span", { style: { color: '#94a3b8' }, children: ["Sua Empresa: ", _jsx("strong", { style: { color: '#ffffff' }, children: `${tClient}d` }), " vs Mercado: ", _jsx("span", { style: { color: '#cbd5e1' }, children: `${tMarket}d` })] }), _jsx("span", { style: {
                                                    fontSize: '0.68rem',
                                                    fontWeight: 700,
                                                    color: statusColor,
                                                    padding: '1px 5px',
                                                ...
                                                }, children: statusText })] }), _jsxs("div", { style: { height: '4px', background: 'rgba(255, 255, 255, 0.05)', borderRadius: '2px', overflow: 'hidden', position: 'relative', marginTop: '0.1rem' }, children: [_jsx("div", { style: { position: 'absolute', left: 0, top: 0, height: '100%', width: '100%', background: 'rgba(255,255,255,0.06)' } }), _jsx("div", { style: {
                                                        position: 'absolute',
                                                        left: 0,
                                                        top: 0,
                                                        height: '100%',
                ...
                _jsxs("div", { className: `bfd-map-right-panel bfd-map-right-panel--${activeTab}`, children: [_jsxs("div", { className: "bfd-map-panel__header", children: [_jsxs("div", { style: { display: 'flex', alignItems: 'center', justifyContent: 'space-between' }, children: [_jsx("span", { className: "bfd-map-panel__title", children: "Rankings Globais" }), _jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: '5px' }, children: [_jsx("span", { className: "bfd-map-panel__live-dot" }), _jsx("span", { style: { fontSize: '0.62rem', fontWeight: 800, color: '#60a5fa', textTransform: 'uppercase', letterSpacing: '0.06em' }, children: "LIVE FEED" })] })] }), _jsx("span", { className: "bfd-map-panel__subtitle", children: "Rankings em tempo real \u2022 200 bids" })] }), _jsxs("div", { className: "bfd-map-panel__tabs", children: [_jsxs("button", { className: `bfd-map-panel__tab tab-origens ${activeTab === 'origens' ? 'is-active' : ''}`, onClick: (e) => { e.stopPropagation(); setActiveTab('origens'); }, children: [_jsx(Globe, { size: 13, weight: "bold" }), " Origens"] }), _jsxs("button", { className: `bfd-map-panel__tab tab-destinos ${activeTab === 'destinos' ? 'is-active' : ''}`, onClick: (e) => { e.stopPropagation(); setActiveTab('destinos'); }, children: [_jsx(MapPin, { size: 13, weight: "bold" }), " Destinos"] }), _jsxs("button", { className: `bfd-map-panel__tab tab-modal_cotacao_bid_frete_internacional ${activeTab === 'modal_cotacao_bid_frete_internacional' ? 'is-active' : ''}`, onClick: (e) => { e.stopPropagation(); setActiveTab('modal_cotacao_bid_frete_internacional'); }, children: [_jsx(List, { size: 13, weight: "bold" }), " Modais"] })] }), _jsxs("div", { className: "bfd-map-panel__list", children: [activeTab === 'origens' && TOP_ORIGENS.map(item => {
                        ...
                        return (_jsx("div", { className: "modal_resumido_cotacao_bid_frete_internacional-overlay", onClick: () => setSelectedPinForModalResumido(null), children: _jsxs("div", { className: "modal_resumido_cotacao_bid_frete_internacional-card", onClick: e => e.stopPropagation(), children: [_jsxs("div", { className: "modal_resumido_cotacao_bid_frete_internacional-header", children: [_jsxs("div", { className: "modal_resumido_cotacao_bid_frete_internacional-title-group", children: [_jsx("span", { className: "modal_resumido_cotacao_bid_frete_internacional-flag-large", children: pin.flag }), _jsxs("div", { children: [_jsxs("h2", { className: "modal_resumido_cotacao_bid_frete_internacional-title", children: ["Rotas Ativas: ", pin.label] }), _jsxs("span", { className: "modal_resumido_cotacao_bid_frete_internacional-subtitle", children: [pin.portCode, " \u2022 ", pin.country] })] })] }), _jsx("button", { className: "modal_resumido_cotacao_bid_frete_internacional-close-btn", onClick: () => setSelectedPinForModalResumido(null), children: "\u2715" })] }), _jsx("div", { className: "modal_resumido_cotacao_bid_frete_internacional-body", children: connections.length === 0 ? (_jsx("div", { style: { padding: '2rem', textAlign: 'center', color: '#94a3b8', fontSize: '0.9rem' }, children: "Nenhuma rota ativa cadastrada para este terminal." })) : (connections.map((route, idx) => {
                                            const isAir = route.mode === 'AEREO';
                                            ...
                                            return (_jsxs("div", { className: cardClass, children: [_jsxs("div", { className: "bfd-route-header", children: [_jsxs("div", { className: "bfd-route-ports", children: [_jsx("span", { className: "bfd-route-port-flag", children: route.fromFlag }), _jsx("span", { className: "bfd-route-port-name", children: route.fromPort }), _jsx("span", { className: "bfd-route-arrow-icon", children: "\u2794" }), _jsx("span", { className: "bfd-route-port-flag", children: route.toFlag }), _jsx("span", { className: "bfd-route-port-name", children: route.toPort })] }), _jsxs("span", { className: badgeClass, style: { display: 'flex', alignItems: 'center', gap: '4px' }, children: [modeIcon, " ", route.mode] })] }), _jsx("div", { className: "bfd-route-svg-container", children: _jsxs("svg", { width: "100%", height: "30", viewBox: "0 0 240 30", style: { overflow: 'visible' }, children: [_jsx("path", { d: pathD, fill: "none", stroke: "rgba(255, 255, 255, 0.12)", strokeWidth: "2", strokeDasharray: "4,4" }), _jsx("path", { d: pathD, fill: "none", stroke: modeColor, strokeWidth: "1.5", strokeDasharray: "20, 220", opacity: "0.8", children: _jsx("animate", { attributeName: "stroke-dashoffset", values: "240;0", dur: speed, repeatCount: "indefinite" }) }), _jsxs("g", { children: [isAir ? (
                                                                        ...
                                                                        _jsx("path", { d: "M-8,-2 L4,-2 L8,0 L4,2 L-8,2 Z M-5,-2 L-5,-4 L-2,-4 L-2,-2 Z", fill: "#34d399", style: { filter: 'drop-shadow(0 0 3px rgba(52, 211, 153, 0.6))' } })), _jsx("animateMotion", { path: pathD, dur: speed, repeatCount: "indefinite", rotate: "auto" })] })] }) }), _jsxs("div", { className: "bfd-route-stats", children: [_jsxs("div", { className: "bfd-route-stat-item", children: [_jsx("span", { className: "bfd-route-stat-label", children: "Bids Ativos" }), _jsxs("span", { className: "bfd-route-stat-value", children: [route.bids, " bids"] })] }), _jsxs("div", { className: "bfd-route-stat-item", children: [_jsx("span", { className: "bfd-route-stat-label", children: "Melhor Pre\u00E7o" }), _jsxs("span", { className: "bfd-route-stat-value", style: { color: '#ffffff' }, children: ["USD ", fmtMoeda(route.bestPrice)] })] }), _jsxs("div", { className: "bfd-route-stat-item", children: [_jsx("span", { className: "bfd-route-stat-label", children: "Saving" }), _jsxs("span", { className: "bfd-route-stat-value", style: { color: isAir ? '#a78bfa' : '#34d399' }, children: ["+", route.saving, "%"] })] }), _jsxs("div", { className: "bfd-route-stat-item", children: [_jsx("span", { className: "bfd-route-stat-label", children: "Transit Time" }), _jsxs("span", { className: "bfd-route-stat-value", children: [route.transitTime, " dias"] })] })] }), _jsxs("div", { style: { marginTop: '0.75rem', display: 'flex', flexDirection: 'column', gap: '0.25rem' }, children: [_jsxs("div", { style: { display: 'flex', justifyContent: 'space-between', fontSize: '0.68rem', fontWeight: 600 }, children: [_jsx("span", { style: { color: '#94a3b8' }, children: "Benchmarking Transit Time" }), _jsxs("span", { style: { color: isAir ? '#c084fc' : '#34d399' }, children: ["Sua Empresa: ", route.transitTime, "d vs Mercado: ", route.transitTime + 3, "d"] })] }), _jsxs("div", { style: { height: '4px', background: 'rgba(255, 255, 255, 0.06)', borderRadius: '2px', overflow: 'hidden', position: 'relative' }, children: [_jsx("div", { style: { position: 'absolute', left: 0, top: 0, height: '100%', width: '100%', background: 'rgba(255,255,255,0.12)' } }), _jsx("div", { style: {
                                                                            position: 'absolute',
                                                                            left: 0,
                                                                            top: 0,
                                                                            height: '100%',
                                        ...
                                        })) }), _jsx("div", { className: "modal_resumido_cotacao_bid_frete_internacional-footer", children: _jsx("button", { className: "modal_resumido_cotacao_bid_frete_internacional-close-action", onClick: () => setSelectedPinForModalResumido(null), children: "Fechar" }) })] }) }));
                    })()] })] }));
}
export default function VisaoGeral() {
    ...
    const [cambioModo, setCambioModo] = useState('hoje');
    const [dataSelecionada, setDataSelecionada] = useState('2026-05-22');
    const [futuroDias, setFuturoDias] = useState(30);
    ...
    return (_jsxs("div", { className: "bfd-dashboard", children: [_jsx("style", { children: `
      ...
      ` }), _jsxs("div", { className: "bfd-header", children: [_jsxs("div", { className: "bfd-header__left", children: [_jsx("h1", { children: "Dashboard BID Frete" }), _jsx("p", { children: "Vis\u00E3o geral das cota\u00E7\u00F5es de frete" })] }), _jsx("div", { className: "bfd-header__actions", children: _jsx(BotaoGlobal, { variante: "primario", icone: _jsx(MagnifyingGlass, { weight: "bold", size: 15 }), onClick: () => navigate('/produto/bid-frete/cotacoes/nova'), children: "Buscar frete" }) })] }), _jsxs("div", { className: "bfd-kpi-grid", children: [_jsx(CardBasicoGlobal, { titulo: "Em andamento", icone: _jsx(Clock, { weight: "duotone", size: 16, style: { color: '#fb923c' } }), valor: String(kpis.cotacoes_andamento), tendencia: { valor: '+3/sem', direcao: 'up' }, subtexto: `USD ${fmtMoeda(kpis.valor_andamento_usd)} em aberto`, variante: "padrao", tooltip: _jsxs(_Fragment, { children: [_jsxs("div", { className: "cg-tooltip__row", children: [_jsx("span", { children: "Volume em aberto" }), _jsxs("strong", { children: ["USD ", fmtMoeda(kpis.valor_andamento_usd)] })] }), _jsxs("div", { className: "cg-tooltip__row", children: [_jsx("span", { children: "Cota\u00E7\u00F5es ativas" }), _jsx("strong", { children: kpis.cotacoes_andamento })] }), _jsxs("div", { className: "cg-tooltip__row", children: [_jsx("span", { children: "Mar\u00EDtimo (Estimado)" }), _jsx("strong", { style: { color: '#34d399' }, children: Math.round(kpis.cotacoes_andamento * 0.6) })] }), _jsxs("div", { className: "cg-tooltip__row", children: [_jsx("span", { children: "A\u00E9reo (Estimado)" }), _jsx("strong", { style: { color: '#a78bfa' }, children: Math.round(kpis.cotacoes_andamento * 0.4) })] })] }) }), _jsx(CardBasicoGlobal, { titulo: "Aprovadas", icone: _jsx(CheckCircle, { weight: "duotone", size: 16, style: { color: '#34d399' } }), valor: String(kpis.cotacoes_passadas), tendencia: { valor: '+12%', direcao: 'up' }, subtexto: `USD ${fmtMoeda(kpis.valor_aprovado_usd)} total`, variante: "padrao", tooltip: _jsxs(_Fragment, { children: [_jsxs("div", { className: "cg-tooltip__row", children: [_jsx("span", { children: "Volume fechado" }), _jsxs("strong", { children: ["USD ", fmtMoeda(kpis.valor_aprovado_usd)] })] }), _jsxs("div", { className: "cg-tooltip__row", children: [_jsx("span", { children: "Total aprovado" }), _jsx("strong", { children: kpis.cotacoes_passadas })] }), _jsxs("div", { className: "cg-tooltip__row", children: [_jsx("span", { children: "Taxa de convers\u00E3o" }), _jsx("strong", { style: { color: '#60a5fa' }, children: "78.4%" })] }), _jsxs("div", { className: "cg-tooltip__row", children: [_jsx("span", { children: "Parceiros atendidos" }), _jsx("strong", { children: "14 armadores" })] })] }) }), _jsx(CardBasicoGlobal, { titulo: "Saving M\u00E9dio", icone: _jsx(Coins, { weight: "duotone", size: 16, style: { color: '#34d399' } }), valor: `${kpis.savings.media_saving_percentual}%`, tendencia: { valor: '+2.3pp', direcao: 'up' }, subtexto: `USD ${fmtMoeda(kpis.savings.total_saving_usd)} acumulado`, variante: "padrao", tooltip: _jsxs(_Fragment, { children: [_jsxs("div", { className: "cg-tooltip__row", children: [_jsx("span", { children: "Saving acumulado" }), _jsxs("strong", { children: ["USD ", fmtMoeda(kpis.savings.total_saving_usd)] })] }), _jsxs("div", { className: "cg-tooltip__row", children: [_jsx("span", { children: "Saving percentual" }), _jsxs("strong", { style: { color: '#34d399' }, children: [kpis.savings.media_saving_percentual, "%"] })] }), _jsxs("div", { className: "cg-tooltip__row", children: [_jsx("span", { children: "Benchmark target" }), _jsx("strong", { children: "12.0%" })] }), _jsxs("div", { className: "cg-tooltip__row", children: [_jsx("span", { children: "Performance vs target" }), _jsxs("strong", { style: { color: '#34d399' }, children: ["+", (kpis.savings.media_saving_percentual - 12).toFixed(1), " pp"] })] })] }) }), _jsx(CardBasicoGlobal, { titulo: "Tempo M\u00E9dio de Resposta", icone: _jsx(Timer, { weight: "duotone", size: 16, style: { color: '#60a5fa' } }), valor: "2.4 d", tendencia: { valor: '-0.8d', direcao: 'down' }, subtexto: "Meta: 3 dias", variante: "padrao", tooltip: _jsxs(_Fragment, { children: [_jsxs("div", { className: "cg-tooltip__row", children: [_jsx("span", { children: "M\u00E9dia de resposta" }), _jsx("strong", { children: "2.4 dias" })] }), _jsxs("div", { className: "cg-tooltip__row", children: [_jsx("span", { children: "Meta SLA" }), _jsx("strong", { children: "3.0 dias" })] }), _jsxs("div", { className: "cg-tooltip__row", children: [_jsx("span", { children: "Dentro do SLA" }), _jsx("strong", { style: { color: '#34d399' }, children: "92.5%" })] }), _jsxs("div", { className: "cg-tooltip__row", children: [_jsx("span", { children: "Principal gargalo" }), _jsx("strong", { style: { color: '#fb923c' }, children: "Santos (SLA 3.8d)" })] })] }) })] }), _jsxs("div", { className: "bfd-globe-row", children: [_jsx(VisaoGeralMapa, { onOpenCompleto: (route) => {
                            ...
                            setIsModalCompletoOpen(true);
                                            ...
                                            if (a.cor === 'orange' || a.cor === 'yellow') {
                                                icon = _jsx(ChatText, { size: 16, weight: "duotone" });
                                                ...
                                                icon = _jsx(Bell, { size: 16, weight: "duotone" });
                                                ...
                                                icon = _jsx(CheckCircle, { size: 16, weight: "duotone" });
                                            ...
                                            return (_jsxs("div", { className: "bfd-alertas__glow-card", onClick: () => {
                                                ...
                                                }, children: [_jsxs("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }, children: [_jsx("span", { style: { color: borderLeftColor, display: 'flex', alignItems: 'center' }, children: icon }), _jsx("span", { style: { fontSize: '1.2rem', fontWeight: 800, color: '#ffffff', letterSpacing: '-0.02em', lineHeight: 1 }, children: a.count })] }), _jsx("span", { style: { fontSize: '0.78rem', fontWeight: 600, color: '#cbd5e1', lineHeight: '1.2', marginTop: '0.35rem', letterSpacing: '0.01em' }, children: a.label })] }, i));
                                        }) })] }), _jsxs("div", { className: "bfd-card bfd-card--accent-indigo", style: { flex: 1, padding: '1.25rem 1.5rem' }, children: [_jsxs("div", { className: "cg-card__header", style: { marginBottom: '1.25rem' }, children: [_jsx("div", { className: "cg-card__icon-wrap", children: _jsx(Funnel, { weight: "duotone", size: 16, style: { color: '#818cf8' } }) }), _jsx("p", { className: "cg-card__label", style: { margin: 0 }, children: "Funil de Cota\u00E7\u00F5es" })] }), _jsx(FunilStatus, {})] })] })] }), _jsxs("div", { className: "bfd-charts-grid", children: [_jsxs("div", { className: "bfd-card bfd-card--accent-blue", children: [_jsxs("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.25rem' }, children: [_jsxs("div", { className: "cg-card__header", children: [_jsx("div", { className: "cg-card__icon-wrap", children: _jsx(ChartBar, { weight: "duotone", size: 16, style: { color: '#3b82f6' } }) }), _jsx("p", { className: "cg-card__label", style: { margin: 0 }, children: "Cota\u00E7\u00F5es por M\u00EAs" })] }), _jsx("span", { className: "bfd-chart__subtitle", children: "\u00DAltimos 6 meses" })] }), _jsx(GraficoBarrasMensal, {}), _jsxs("div", { className: "bfd-chart__legend", children: [_jsxs("span", { children: [_jsx("span", { className: "bfd-chart__legend-dot", style: { background: '#60a5fa' } }), " Aprovadas"] }), _jsxs("span", { children: [_jsx("span", { className: "bfd-chart__legend-dot", style: { background: '#8b5cf6' } }), " Em andamento"] }), _jsxs("span", { children: [_jsx("span", { className: "bfd-chart__legend-dot", style: { background: '#f87171' } }), " Recusadas"] })] })] }), _jsxs("div", { className: "bfd-card bfd-card--accent-emerald", children: [_jsxs("div", { className: "cg-card__header", style: { marginBottom: '1.25rem' }, children: [_jsx("div", { className: "cg-card__icon-wrap", children: _jsx(ChartPie, { weight: "duotone", size: 16, style: { color: '#34d399' } }) }), _jsx("p", { className: "cg-card__label", style: { margin: 0 }, children: "Distribui\u00E7\u00E3o por Modal" })] }), _jsx(GraficoDonutModal, {})] }), _jsxs("div", { className: "bfd-card bfd-card--accent-blue", style: { height: '100%', justifyContent: 'flex-start', display: 'flex', flexDirection: 'column' }, children: [_jsx("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }, children: _jsxs("div", { className: "cg-card__header", children: [_jsx("div", { className: "cg-card__icon-wrap", children: _jsx(CurrencyDollar, { weight: "duotone", size: 16, style: { color: '#3b82f6' } }) }), _jsx("p", { className: "cg-card__label", style: { margin: 0 }, children: "C\u00E2mbio PTAX (BACEN)" })] }) }), _jsx("div", { style: { display: 'flex', gap: '0.25rem', background: 'rgba(255, 255, 255, 0.04)', padding: '0.2rem', borderRadius: '8px', marginBottom: '0.85rem' }, children: [
                                    { id: 'hoje', label: 'Hoje' },
                                    { id: 'historico', label: 'Histórico' },
                                    { id: 'futuro', label: 'Futuro' },
                                ].map(tab => (_jsx("button", { onClick: () => setCambioModo(tab.id), style: {
                                        flex: 1,
                                        ...
                                        transition: 'all 0.2s ease',
                                    }, children: tab.label }, tab.id))) }), cambioModo === 'historico' && (_jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: '0.25rem', marginBottom: '0.85rem' }, children: [_jsx("label", { style: { fontSize: '0.62rem', fontWeight: 700, color: '#94a3b8', letterSpacing: '0.05em' }, children: "SELECIONAR DATA PTAX" }), _jsxs("div", { style: { position: 'relative', display: 'flex', alignItems: 'center' }, children: [_jsx(CalendarBlank, { size: 14, style: { position: 'absolute', left: '8px', color: '#94a3b8' } }), _jsx("input", { type: "date", value: dataSelecionada, max: "2026-05-22", onChange: (e) => setDataSelecionada(e.target.value), style: {
                                                    background: 'rgba(255, 255, 255, 0.04)',
                                                    border: '1px solid rgba(255, 255, 255, 0.08)',
                                                    borderRadius: '6px',
                                                    ...
                                                    width: '100%',
                                                    fontFamily: 'inherit',
                                                } })] })] })), cambioModo === 'futuro' && (_jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: '0.25rem', marginBottom: '0.85rem' }, children: [_jsx("label", { style: { fontSize: '0.62rem', fontWeight: 700, color: '#94a3b8', letterSpacing: '0.05em' }, children: "HORIZONTE HEDGE" }), _jsx("div", { style: { display: 'flex', gap: '0.25rem' }, children: [30, 90, 180, 360].map(dias => (_jsxs("button", { onClick: () => setFuturoDias(dias), style: {
                                                flex: 1,
                                                padding: '0.3rem',
                                                fontSize: '0.7rem',
                                                fontWeight: 700,
                                            ...
                                            }, children: ["+", dias, "d"] }, dias))) })] })), _jsx("div", { className: "bfd-cambio", style: { display: 'flex', flexDirection: 'column', gap: '0.1rem', margin: cambioModo === 'hoje' ? 'auto 0' : '0' }, children: obterCotacoes.map(m => (_jsxs("div", { className: "bfd-cambio__row", style: { padding: '0.55rem 0', display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderBottom: '1px solid rgba(255,255,255,0.06)' }, children: [_jsx("span", { className: "bfd-cambio__code", style: { fontSize: '0.82rem', fontWeight: 700, color: '#ffffff', minWidth: '40px' }, children: m.codigo }), _jsxs("span", { className: "bfd-cambio__val", style: { fontSize: '0.82rem', color: '#cbd5e1', flex: 1, fontWeight: 600, paddingLeft: '0.5rem' }, children: ["R$ ", m.valor_brl.toFixed(2).replace('.', ',')] }), _jsxs("span", { className: "bfd-cambio__var", style: {
                                                fontSize: '0.72rem',
                                                fontWeight: 700,
                                            ...
                                            }, children: [m.variacao >= 0 ? '+' : '', m.variacao.toFixed(2).replace('.', ','), "%"] })] }, m.codigo))) })] }), _jsxs("div", { className: "bfd-card bfd-card--accent-blue", style: { height: '100%', justifyContent: 'flex-start', display: 'flex', flexDirection: 'column' }, children: [_jsx("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }, children: _jsxs("div", { className: "cg-card__header", children: [_jsx("div", { className: "cg-card__icon-wrap", children: _jsx(ChartLine, { weight: "duotone", size: 16, style: { color: '#3b82f6' } }) }), _jsx("p", { className: "cg-card__label", style: { margin: 0 }, children: "Spread M\u00E9dio Aplicado" })] }) }), _jsx("div", { style: { display: 'flex', flexDirection: 'column', gap: '0.85rem', margin: 'auto 0' }, children: [
                                    { moeda: 'USD', valor: '1,85%', pct: 60, cor: '#3b82f6' },
                                    { moeda: 'EUR', valor: '2,10%', pct: 75, cor: '#8b5cf6' },
                                    { moeda: 'CNY', valor: '1,45%', pct: 45, cor: '#fbbf24' },
                                ].map(item => (_jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: '0.3' }, children: [_jsxs("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center' }, children: [_jsx("span", { style: { fontSize: '0.82rem', fontWeight: 700, color: '#ffffff' }, children: item.moeda }), _jsx("span", { style: { fontSize: '0.82rem', fontWeight: 700, color: '#60a5fa' }, children: item.valor })] }), _jsx("div", { style: { height: '6px', background: 'rgba(255, 255, 255, 0.08)', borderRadius: '3px', overflow: 'hidden', position: 'relative' }, children: _jsx("div", { style: {
                                                    height: '100%',
                                                    width: `${item.pct}%`,
                ...
                const dotColor = context.tipo === 'route'
                    ? (context.mode === 'AEREO' ? '#a78bfa' : '#34d399')
                    : (context.cor === 'red' ? '#f87171' : context.cor === 'orange' ? '#fbbf24' : context.cor === 'green' ? '#34d399' : '#60a5fa');
              ...
              ` }), _jsxs("div", { className: "bfd-modal-card", style: {
                                ...
                                animation: 'scaleIn 0.3s cubic-bezier(0.34, 1.56, 0.64, 1)'
                                        ...
                                        return (_jsx("button", { style: {
                                                ...
                                                transition: 'all 0.2s'
                                    ...
                                    }) }), _jsxs("div", { style: { flex: 1, overflowY: 'auto', padding: '1.5rem', minHeight: '300px' }, children: [alertModalTab === 'geral' && (_jsxs("div", { style: { display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '1.25rem' }, children: [_jsxs("div", { className: "bfd-modal-field", children: [_jsx("label", { style: { display: 'block', fontSize: '0.72rem', fontWeight: 600, color: '#94a3b8', textTransform: 'uppercase', marginBottom: '0.35rem' }, children: "Origem" }), _jsx("div", { style: { background: 'rgba(255, 255, 255, 0.03)', border: '1px solid rgba(255, 255, 255, 0.05)', borderRadius: '6px', padding: '0.6rem 0.8rem', fontSize: '0.9rem', color: '#f1f5f9' }, children: origin })] }), _jsxs("div", { className: "bfd-modal-field", children: [_jsx("label", { style: { display: 'block', fontSize: '0.72rem', fontWeight: 600, color: '#94a3b8', textTransform: 'uppercase', marginBottom: '0.35rem' }, children: "Destino" }), _jsx("div", { style: { background: 'rgba(255, 255, 255, 0.03)', border: '1px solid rgba(255, 255, 255, 0.05)', borderRadius: '6px', padding: '0.6rem 0.8rem', fontSize: '0.9rem', color: '#f1f5f9' }, children: destination })] }), _jsxs("div", { className: "bfd-modal-field", style: { gridColumn: 'span 2' }, children: [_jsx("label", { style: { display: 'block', fontSize: '0.72rem', fontWeight: 600, color: '#94a3b8', textTransform: 'uppercase', marginBottom: '0.35rem' }, children: "Mercadoria / Descri\u00E7\u00E3o" }), _jsx("div", { style: { background: 'rgba(255, 255, 255, 0.03)', border: '1px solid rgba(255, 255, 255, 0.05)', borderRadius: '6px', padding: '0.6rem 0.8rem', fontSize: '0.9rem', color: '#f1f5f9' }, children: goods })] }), _jsxs("div", { className: "bfd-modal-field", children: [_jsx("label", { style: { display: 'block', fontSize: '0.72rem', fontWeight: 600, color: '#94a3b8', textTransform: 'uppercase', marginBottom: '0.35rem' }, children: "Peso Total" }), _jsx("div", { style: { background: 'rgba(255, 255, 255, 0.03)', border: '1px solid rgba(255, 255, 255, 0.05)', borderRadius: '6px', padding: '0.6rem 0.8rem', fontSize: '0.9rem', color: '#f1f5f9' }, children: weight })] }), _jsxs("div", { className: "bfd-modal-field", children: [_jsx("label", { style: { display: 'block', fontSize: '0.72rem', fontWeight: 600, color: '#94a3b8', textTransform: 'uppercase', marginBottom: '0.35rem' }, children: "Cubagem (M\u00B3)" }), _jsx("div", { style: { background: 'rgba(255, 255, 255, 0.03)', border: '1px solid rgba(255, 255, 255, 0.05)', borderRadius: '6px', padding: '0.6rem 0.8rem', fontSize: '0.9rem', color: '#f1f5f9' }, children: volume })] }), _jsxs("div", { className: "bfd-modal-field", children: [_jsx("label", { style: { display: 'block', fontSize: '0.72rem', fontWeight: 600, color: '#94a3b8', textTransform: 'uppercase', marginBottom: '0.35rem' }, children: "Incoterm" }), _jsx("div", { style: { background: 'rgba(255, 255, 255, 0.03)', border: '1px solid rgba(255, 255, 255, 0.05)', borderRadius: '6px', padding: '0.6rem 0.8rem', fontSize: '0.9rem', color: '#f1f5f9' }, children: incoterm })] }), _jsxs("div", { className: "bfd-modal-field", children: [_jsx("label", { style: { display: 'block', fontSize: '0.72rem', fontWeight: 600, color: '#94a3b8', textTransform: 'uppercase', marginBottom: '0.35rem' }, children: "Valor Limite / Estimado" }), _jsx("div", { style: { background: 'rgba(255, 255, 255, 0.03)', border: '1px solid rgba(255, 255, 255, 0.05)', borderRadius: '6px', padding: '0.6rem 0.8rem', fontSize: '0.9rem', color: '#f1f5f9' }, children: value })] }), _jsxs("div", { className: "bfd-modal-field", style: { gridColumn: 'span 2' }, children: [_jsx("label", { style: { display: 'block', fontSize: '0.72rem', fontWeight: 600, color: '#94a3b8', textTransform: 'uppercase', marginBottom: '0.35rem' }, children: "Modalidade" }), _jsx("div", { style: { background: 'rgba(255, 255, 255, 0.03)', border: '1px solid rgba(255, 255, 255, 0.05)', borderRadius: '6px', padding: '0.6rem 0.8rem', fontSize: '0.9rem', color: '#f1f5f9' }, children: category })] })] })), alertModalTab === 'itens' && (_jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: '0.75rem' }, children: [_jsxs("div", { style: { display: 'flex', background: 'rgba(255,255,255,0.02)', padding: '0.5rem 0.75rem', borderRadius: '4px', borderBottom: '1px solid rgba(255,255,255,0.05)', fontSize: '0.78rem', fontWeight: 700, color: '#94a3b8' }, children: [_jsx("div", { style: { flex: 1 }, children: "C\u00F3digo" }), _jsx("div", { style: { flex: 2 }, children: "Descri\u00E7\u00E3o" }), _jsx("div", { style: { flex: 1, textAlign: 'right' }, children: "Qtd" }), _jsx("div", { style: { flex: 1, textAlign: 'right' }, children: "Peso (Kg)" })] }), _jsxs("div", { style: { display: 'flex', padding: '0.75rem', borderRadius: '6px', background: 'rgba(255,255,255,0.01)', border: '1px solid rgba(255,255,255,0.03)', fontSize: '0.85rem' }, children: [_jsx("div", { style: { flex: 1, color: '#60a5fa', fontWeight: 600 }, children: "ITM-01" }), _jsx("div", { style: { flex: 2, color: '#cbd5e1' }, children: goods }), _jsx("div", { style: { flex: 1, textAlign: 'right', color: '#ffffff' }, children: "1.000 un" }), _jsx("div", { style: { flex: 1, textAlign: 'right', color: '#ffffff' }, children: weight })] })] })), alertModalTab === 'propostas' && (_jsx("div", { style: { display: 'flex', flexDirection: 'column', gap: '0.85rem' }, children: proposals.map((p, idx) => (_jsxs("div", { style: {
                                                    display: 'flex',
                                                    justifyContent: 'space-between',
                                                    alignItems: 'center',
                                                    padding: '1rem',
                                                    ...
                                                    borderRadius: '8px',
                                                    transition: 'all 0.2s'
                                                }, children: [_jsxs("div", { children: [_jsx("span", { style: { fontSize: '0.9rem', fontWeight: 700, color: '#ffffff', display: 'block' }, children: p.fornecedor }), _jsxs("span", { style: { fontSize: '0.75rem', color: '#94a3b8' }, children: ["Transit time: ", p.transit] })] }), _jsxs("div", { style: { textAlign: 'right' }, children: [_jsx("span", { style: { fontSize: '0.95rem', fontWeight: 800, color: '#60a5fa', display: 'block' }, children: p.valor }), _jsx("span", { style: { display: 'inline-block', fontSize: '0.7rem', fontWeight: 700, padding: '2px 8px', borderRadius: '12px', background: p.cor + '22', color: p.cor }, children: p.status })] })] }, idx))) })), alertModalTab === 'historico' && (_jsx("div", { style: { display: 'flex', flexDirection: 'column', gap: '1.25rem', paddingLeft: '1rem', borderLeft: '2px solid rgba(255, 255, 255, 0.05)', position: 'relative' }, children: history.map((h, idx) => (_jsxs("div", { style: { position: 'relative' }, children: [_jsx("span", { style: {
                                                            position: 'absolute',
                                                            left: '-1.45rem',
                                                            top: '4px',
                                                            width: '10px',
                                                        ...
                                                        } }), _jsxs("span", { style: { fontSize: '0.72rem', color: '#94a3b8', display: 'block', fontWeight: 600 }, children: [h.data, " \u2022 por ", h.autor] }), _jsx("span", { style: { fontSize: '0.85rem', color: '#cbd5e1', marginTop: '0.2rem', display: 'block' }, children: h.texto })] }, idx))) }))] }), _jsxs("div", { style: { display: 'flex', justifyContent: 'flex-end', gap: '0.75rem', padding: '1rem 1.5rem', borderTop: '1px solid rgba(255, 255, 255, 0.06)', background: 'rgba(15, 23, 42, 0.2)' }, children: [_jsx("button", { style: {
                                                background: 'rgba(255, 255, 255, 0.05)',
                                                border: '1px solid rgba(255, 255, 255, 0.08)',
                                                borderRadius: '8px',
                                                color: '#f1f5f9',
