/**
 * Helpers compartilhados de período do Dashboard BID Frete — labels e chips de filtro.
 * Paridade com servicos-global/produto/pedido/client/src/shared/dashboardPeriodoUtil.ts
 */
