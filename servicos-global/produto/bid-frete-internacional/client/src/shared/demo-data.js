export const DEMO_KPIS = {
    ...
    funil: [
        { status: 'RASCUNHO', count: 15 },
        { status: 'ENVIADA_FORNECEDORES', count: 35 },
        { status: 'EM_COTACAO', count: 110 },
        { status: 'AGUARDANDO_APROVACAO', count: 40 },
        { status: 'APROVADA', count: 840 },
        { status: 'REPROVADA', count: 68 },
        { status: 'EXPIRADA', count: 42 },
    ],
...
export const DEMO_MODAL = [
    { modal_cotacao_bid_frete_internacional: 'MARITIMO', count: 120, pct: 60, cor: '#34d399' }, // 60% Maritime quotes
    { modal_cotacao_bid_frete_internacional: 'AEREO', count: 80, pct: 40, cor: '#a78bfa' }, // 40% Air quotes (colors match the globe route lines)
];
export const DEMO_MELHOR_COTACAO = {
    numero_cotacao_bid_frete_internacional: 'OF-2028-0142',
    origem: 'Shanghai (CNSHA)',
    destino: 'Santos (BRSSZ)',
    modal_cotacao_bid_frete_internacional: 'MARITIMO',
    saving_pct: 23.4,
    ganho_valor_cotacao_bid_frete_internacional: 12480,
    valor_aprovado_ganho_bid_frete_internacional: 80480,
    fornecedor: 'Pacific Cargo (E96)',
    transit_time: 32,
};
export const DEMO_INCOTERMS = [
    { incoterm_cotacao_bid_frete_internacional: 'FOB', count: 88, pct: 44 },
    { incoterm_cotacao_bid_frete_internacional: 'CIF', count: 62, pct: 31 },
    { incoterm_cotacao_bid_frete_internacional: 'EXW', count: 38, pct: 19 },
    { incoterm_cotacao_bid_frete_internacional: 'DAP', count: 12, pct: 6 },
    { incoterm_cotacao_bid_frete_internacional: 'CFR', count: 0, pct: 0 },
];
