...
export const FILTRO_TIPO_OVERRIDES_BID_FRETE: Record<string, FiltroTipo> = {
  ...
  modal_cotacao_bid_frete_internacional: 'enum',
  modalidade_cotacao_bid_frete_internacional: 'enum',
  id_workspace: 'enum',
  id_organizacao: 'enum',
  id_usuario: 'enum',
  id_produto_gravity: 'enum',
  incoterm_cotacao_bid_frete_internacional: 'enum',
  visibilidade_cotacao_bid_frete_internacional: 'enum',
  anonima_cotacao_bid_frete_internacional: 'enum',
  moeda_meta_cotacao_bid_frete_internacional: 'enum',
  tipo_container_cotacao_bid_frete_internacional: 'enum',
