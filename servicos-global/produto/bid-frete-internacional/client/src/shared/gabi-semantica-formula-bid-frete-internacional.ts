...
import { parsearFormula } from './formula-engine-coluna-bid-frete-internacional.js'
import type { FormulaAST } from './formula-engine-coluna-bid-frete-internacional.js'
...
export const SEMANTICA_CAMPOS: Record<string, MetaCampo> = {
  ganho_valor_cotacao_bid_frete_internacional: { label: 'Ganho (valor)', unidade: 'fin', papel: 'total' },
  ganho_percentual_cotacao_bid_frete_internacional: { label: 'Ganho (%)', unidade: 'fin', papel: 'calculado' },
  valor_total_proposta_bid_frete_internacional: { label: 'Valor total proposta', unidade: 'fin', papel: 'total' },
  valor_frete_proposta_bid_frete_internacional: { label: 'Valor do frete', unidade: 'fin', papel: 'parcela', parcelaDe: 'valor_total_proposta_bid_frete_internacional' },
  taxas_origem_proposta_bid_frete_internacional: { label: 'Taxas origem', unidade: 'fin', papel: 'parcela' },
  taxas_destino_proposta_bid_frete_internacional: { label: 'Taxas destino', unidade: 'fin', papel: 'parcela' },
  dias_transito_proposta_bid_frete_internacional: { label: 'Dias trânsito', unidade: 'qtd', papel: 'calculado' },
}
