/** Dimensões dos mini-gráficos (sparks) nos cards de proposta — sem dependência React. */
export const SPARK_VIEW_MELHOR_PROPOSTA = { w: 88, h: 180 } as const
export const SPARK_SLOT_MELHOR_PROPOSTA_PX = 52

/** Faixa comparativa nos cards de ranking (Respostas) — viewBox mais largo + slot mais alto. */
