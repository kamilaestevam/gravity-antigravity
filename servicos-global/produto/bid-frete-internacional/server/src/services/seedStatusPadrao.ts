...
const STATUS_CANONICOS: StatusSeed[] = [
  ...
  { nome_status_cotacao_config_bid_frete_internacional: 'CANCELADA', rotulo_status_cotacao_config_bid_frete_internacional: 'Cancelada', cor_status_cotacao_config_bid_frete_internacional: '#6b7280', ordem_status_cotacao_config_bid_frete_internacional: 7, gerenciado_sistema_status_cotacao_config_bid_frete_internacional: true, padrao_status_cotacao_config_bid_frete_internacional: true },
