/**
 * Contrato bilateral — config_json dos painéis da Lista (BID Frete Internacional v1).
 */
import { z } from 'zod'

export const ID_PRODUTO_GRAVITY_BID_FRETE_INTERNACIONAL = 'bid-frete-internacional' as const
...
export function configListaPainelPadraoV1(
  ...
  return {
    versao: 1,
    colunas_visiveis: [],
    aba_status_ativa: 'TODAS',
    filtros_coluna: {},
    ordenacao: { campo: 'numero_cotacao_bid_frete_internacional', direcao: 'desc' },
    ...overrides,
  }
}
