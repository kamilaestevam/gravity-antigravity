...
export default function Comparativo() {
  ...
  const tituloTopo = useMemo(() => {
    ...
    return {
      ...
      subtitulo: cotacao
        ? `${cotacao.numero_cotacao_bid_frete} — ${cotacao.porto_origem_cotacao_bid_frete} → ${cotacao.porto_destino_cotacao_bid_frete}`
      ...
      <PaginaGlobal className="bf-comparativo bid-frete-page-shell">
        <div className="bf-aprovacao-result">
          ...
          <div className="bf-aprovacao-result-acoes">
            ...
            <button className="btn btn-primary" onClick={() => navigate('/bid-frete/cotacoes')}>
