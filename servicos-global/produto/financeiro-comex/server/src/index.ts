 ...
 * Localização canônica: servicos-global/produto/financeiro-comex/server/
 * Porta: 8029
 */
...
app.use((_req: Request, res: Response, next: NextFunction) => {
  ...
  res.setHeader('Access-Control-Allow-Headers', 'Content-Type, Authorization, x-internal-key, x-id-organizacao, x-id-usuario, x-id-workspace, x-correlation-id')
