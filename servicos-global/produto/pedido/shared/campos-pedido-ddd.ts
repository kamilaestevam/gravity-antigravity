...
export const CAMPOS_PEDIDO_DDD: CampoPedidoDDD[] = [
  ...
  { campo: 'tipo_linha',                                   rotulo: 'Tipo Linha',                             tipo: 'select', nivel: 'pedido', grupo: 'Identificacao', opcoesSelect: ['PEDIDO', 'ITEM'], aliasesLegados: ['row type', 'tipo de linha', 'linha'] },
  { campo: 'numero_pedido',                                rotulo: 'Numero do Pedido',                       tipo: 'texto',  nivel: 'pedido', grupo: 'Identificacao', aliasesLegados: ['po number', 'po no', 'purchase order', 'purchase order number', 'order number', 'order no', 'numero pedido', 'num pedido', 'n pedido', 'po num', 'sales order', 'so number', 'so no'] },
  { campo: 'tipo_operacao',                                rotulo: 'Tipo de Operacao',                       tipo: 'select', nivel: 'pedido', grupo: 'Identificacao', opcoesSelect: ['importacao', 'exportacao'], aliasesLegados: ['tipo operacao', 'operation type', 'operacao', 'import export', 'import/export'] },

  // Exportador
  { campo: 'nome_exportador',                              rotulo: 'Exportador — Nome',                      tipo: 'texto',  nivel: 'pedido', grupo: 'Exportador', aliasesLegados: ['exporter', 'exporter name', 'shipper', 'shipper name', 'supplier', 'supplier name', 'vendor', 'vendor name', 'seller', 'nome exportador'] },
  ...
  // Importador
  { campo: 'nome_importador',                              rotulo: 'Importador — Nome',                      tipo: 'texto',  nivel: 'pedido', grupo: 'Importador', aliasesLegados: ['importer', 'importer name', 'buyer', 'buyer name', 'consignee', 'importador'] },
  { campo: 'cnpj_importador_pedido',                       rotulo: 'Importador — CNPJ',                      tipo: 'texto',  nivel: 'pedido', grupo: 'Importador' },

  // Fabricante
  { campo: 'nome_fabricante',                              rotulo: 'Fabricante — Nome',                      tipo: 'texto',  nivel: 'pedido', grupo: 'Fabricante', aliasesLegados: ['manufacturer', 'manufacturer name', 'maker', 'producer', 'factory', 'fabricante'] },
  ...
  // Comercial
  { campo: 'incoterm_pedido',                              rotulo: 'Incoterm',                               tipo: 'texto',  nivel: 'pedido', grupo: 'Comercial', aliasesLegados: ['incoterms', 'delivery terms', 'trade terms'] },
  { campo: 'moeda_pedido',                                 rotulo: 'Moeda',                                  tipo: 'texto',  nivel: 'pedido', grupo: 'Comercial', aliasesLegados: ['currency', 'currency code', 'curr', 'ccy'] },
  ...
  { campo: 'unidade_comercializada_pedido',                rotulo: 'Unidade Comercializada',                 tipo: 'texto',  nivel: 'pedido', grupo: 'Comercial', aliasesLegados: ['unit', 'uom', 'unit of measure'] },
  ...
  { campo: 'referencia_importador_pedido',                 rotulo: 'Referencia Importador',                  tipo: 'texto',  nivel: 'pedido', grupo: 'Documentos', aliasesLegados: ['buyer ref', 'importer ref', 'internal ref'] },
  { campo: 'referencia_exportador_pedido',                 rotulo: 'Referencia Exportador',                  tipo: 'texto',  nivel: 'pedido', grupo: 'Documentos', aliasesLegados: ['seller ref', 'supplier ref', 'vendor ref', 'exporter ref'] },
...
export const CAMPOS_ITEM_DDD: CampoPedidoDDD[] = [
  ...
  { campo: 'sequencia_item_pedido',                        rotulo: 'Sequencia do Item',                      tipo: 'numero', nivel: 'item', grupo: 'Produto', aliasesLegados: ['line', 'line no', 'line number', 'item no', 'item number', 'seq', 'sequencia'] },
  { campo: 'part_number_item',                             rotulo: 'Part Number',                            tipo: 'texto',  nivel: 'item', grupo: 'Produto', aliasesLegados: ['part no', 'partnumber', 'sku', 'item code', 'product code', 'codigo produto', 'codigo do produto', 'material', 'zmatnr'] },
  { campo: 'ncm_item',                                     rotulo: 'NCM',                                    tipo: 'texto',  nivel: 'item', grupo: 'Produto', aliasesLegados: ['hs code', 'hs', 'harmonized code', 'tariff code', 'h s code', 'tariff'] },
  { campo: 'descricao_item',                               rotulo: 'Descricao do Item',                      tipo: 'texto',  nivel: 'item', grupo: 'Produto', aliasesLegados: ['description', 'item description', 'product description', 'product name', 'descricao', 'goods description', 'zmaktx'] },
  { campo: 'unidade_comercializada_item',                  rotulo: 'Unidade Comercializada',                 tipo: 'texto',  nivel: 'item', grupo: 'Produto', aliasesLegados: ['unit', 'uom', 'unit of measure', 'unidade', 'zmeins'] },

  // Quantidades
  { campo: 'quantidade_inicial_item',                      rotulo: 'Qtd. Inicial',                           tipo: 'numero', nivel: 'item', grupo: 'Quantidades', aliasesLegados: ['qty', 'quantity', 'qtd', 'qtde', 'quantidade', 'ordered qty', 'order qty', 'qtd pedida', 'qtd inicial', 'pcs', 'pieces', 'zmenge', 'menge'] },
  ...
  { campo: 'valor_por_unidade_item',                       rotulo: 'Valor por Unidade',                      tipo: 'numero', nivel: 'item', grupo: 'Financeiro', aliasesLegados: ['unit price', 'unit value', 'valor unitario', 'preco unitario', 'unit cost', 'price per unit', 'net price', 'znetpr'] },
  { campo: 'valor_total_item',                             rotulo: 'Valor Total do Item',                    tipo: 'numero', nivel: 'item', grupo: 'Financeiro', aliasesLegados: ['total value', 'line total', 'line amount', 'ext price', 'extended price', 'amount', 'valor total', 'fob total', 'fob value', 'zwrbtr'] },
  ...
  // Fisico
  { campo: 'peso_liquido_unitario_item',                   rotulo: 'Peso Liquido Unitario',                  tipo: 'numero', nivel: 'item', grupo: 'Fisico', aliasesLegados: ['net weight unitary', 'unit net weight', 'peso liquido', 'znetgw'] },
  { campo: 'peso_bruto_unitario_item',                     rotulo: 'Peso Bruto Unitario',                    tipo: 'numero', nivel: 'item', grupo: 'Fisico', aliasesLegados: ['gross weight unitary', 'unit gross weight', 'peso bruto'] },
