...
import { STATUS_PEDIDO_LABELS, fmtQuantidade, fmtData, classeMoedaBadge } from '../../shared/lista/pedidoTypes'
import type { RegrasConfigBackend } from '../../shared/lista/pedidoListaContratos'
import { LABELS_FILTRO_INVERSO } from './filtros'
import type { GTUnidadeOpcao } from '../../shared/lista/useUnidadesPedido'
import { getEditavel } from '../../shared/lista/columnBehaviorConfig'
import { enriquecerColunasComRegraTooltip, montarTooltipCelulaComAviso } from '../../shared/lista/buildTooltipRegraLista'
import { obterDescricaoExibicaoPedido, obterNcmExibicaoPedido } from '../../shared/lista/pedidoDivergencias'
...
import { renderRotuloCadastro, type GTOpcaoCadastro } from '../../shared/lista/useLogisticaCadastrosPedido'
...
export function buildColunasPai(t: TFunction, opcoes: OpcoesUnidadesColunas): GTColuna<Pedido>[] {
  ...
  },
  {
    ...
    grupo: 'Quantidades',
    render: (_val: unknown, row: Pedido) => renderQtdPedido(row, 'quantidade_pronta_item', getCasas('quantidade_pronta_itens_pedido_total', 2), { titulo: t('pedido.coluna_pai.quantidade_pronta_itens_pedido_total_titulo'), descricao: t('pedido.coluna_pai.quantidade_pronta_itens_pedido_total_desc') }),
  },
  {
