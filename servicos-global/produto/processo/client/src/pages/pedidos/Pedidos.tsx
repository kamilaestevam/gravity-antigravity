...
export default function Pedidos() {
  ...
  useEffect(() => {
    async function init() {
      ...
      try {
        ...
        if (prefsData) {
          // GTPreferencias atualmente so suporta colunas_visiveis (a API
          // de larguras foi removida — o componente gerencia internamente).
          setPreferencias({
  ...
  async function handleSalvarPreferencias(prefs: GTPreferencias) {
    ...
    await salvarPreferenciasUsuario(idOrganizacao, userId, {
      ...
      // colunas_largura nao e mais gerenciado por GTPreferencias (componente
      // gerencia largura internamente). Campo continua opcional no contrato.
    })
  }
