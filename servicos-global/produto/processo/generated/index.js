...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "servicos-global/produto/processo/generated",
...
path.join(process.cwd(), "servicos-global/produto/processo/generated/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "servicos-global/produto/processo/generated/schema.prisma")
