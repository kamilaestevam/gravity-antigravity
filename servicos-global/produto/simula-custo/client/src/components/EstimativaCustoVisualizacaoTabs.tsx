/**
 * EstimativaCustoVisualizacaoTabs — pills no topo (Insights | Lista | Dashboard | Kanban).
...
import type { EstimativaCustoVisualizacaoId } from './estimativa-custo-visualizacao-context'
...
export function EstimativaCustoVisualizacaoTabs() {
  const { t } = useTranslation()

  return (
    <nav className="ect-tabs" aria-label="Modo de visualização do Estimativa Custo">
      {TABS.map(tab => (
        <NavLink
          key={tab.to}
          to={tab.to}
