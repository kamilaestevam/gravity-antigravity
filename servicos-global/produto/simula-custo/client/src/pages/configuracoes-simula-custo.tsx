...
} from '../shared/preferencias-cards-simula-custo'
import { usePreferenciasKanbanSimulaCusto } from '../shared/preferencias-kanban-simula-custo'
import { STATUS_LABELS } from '../shared/types'
import type { StatusSimulaCusto } from '../shared/schemas-simula-custo'
import './configuracoes-simula-custo.css'
...
export default function Configuracoes() {
  ...
  const { prefs: prefsKanban, salvar: salvarPrefsKanban, alternarColuna } =
    usePreferenciasKanbanSimulaCusto()

  function moverColunaKanban(status: StatusSimulaCusto, direcao: -1 | 1) {
