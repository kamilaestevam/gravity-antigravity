/**
 * dashboard-estimativa-custo.tsx — Dashboard do Estimativa Custo.
...
import { obterKpisEstimativaCusto } from '../shared/api'
import type { KpisEstimativaCusto } from '../shared/schemas-estimativa-custo'
import { useCardPreferences } from '../shared/preferencias-cards-estimativa-custo'
import { useCardValues } from '../shared/valores-cards-estimativa-custo'
import type { CardVariante } from '@nucleo/card-global'
import { STATUS_LABELS } from '../shared/types'
import { rotaSimulaCusto } from '../shared/rotas-estimativa-custo'
import './dashboard-estimativa-custo.css'
...
export default function DashboardEstimativaCusto() {
  ...
  const carregar = useCallback(async () => {
    try { setKpis(await obterKpisEstimativaCusto()) }
    catch { /* mantém zeros */ }
  }, [])
          ...
          <div className="ecd-card__head">
            <div className="cg-card__header">
              ...
              <p className="cg-card__label">
                {t('simulacusto.dashboard.distribuicao_status', 'Estimativas por status')}
              </p>
            </div>
          </div>
          ...
          <div className="ecdb-resumo">
            <div className="ecdb-resumo__item">
              <span className="ecdb-resumo__label">
                {t('simulacusto.estimativas.custo_medio', 'Custo Nacionalizado Médio')}
              </span>
