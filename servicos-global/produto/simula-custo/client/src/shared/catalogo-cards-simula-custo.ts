/**
 * catalogo-cards-simula-custo.ts — Catálogo de cards do Simula Custo
 *
 * Cada entrada representa uma métrica que pode virar card na tela principal.
 * Derivado dos campos KPI da API + colunas da tabela de simulas.
 *
...
export const CARDS_CATALOGO: CardDefinicao[] = [
  {
    id:        'total',
    label:     'Total',
    descricao: 'Número total de simulas criadas',
    iconeKey:  'calculator',
  ...
  },
  {
    id:        'em_criacao',
    label:     'Em Criação',
    descricao: 'Simulas ainda em elaboração',
    iconeKey:  'trend-up',
    cor:       '#fbbf24',
    tipoAgg:   'Contagem',
    variante:  'aviso',
  },
  {
    id:        'criadas',
    label:     'Criadas',
    descricao: 'Simulas finalizadas e aprovadas',
  ...
  },
  {
    id:        'arquivadas',
    label:     'Arquivadas',
    descricao: 'Simulas arquivadas (não ativas)',
    iconeKey:  'archive',
    cor:       '#94a3b8',
    tipoAgg:   'Contagem',
    variante:  'padrao',
  ...
  {
    id:        'custo_nacionalizado_medio',
    label:     'Custo Nacionalizado Médio',
