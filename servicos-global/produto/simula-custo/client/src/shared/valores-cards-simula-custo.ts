...
import type { KpisSimulaCusto } from './schemas-simula-custo'
...
export function computeCardValues(kpis: KpisSimulaCusto): Record<string, CardValor> {
  ...
  return {
    ...
    total_tributos_acumulado: {
      ...
      subtexto: 'Soma de todas as simulas',
      tooltip: React.createElement('p', { className: 'cg-tooltip__row' },
...
export function useCardValues(kpis: KpisSimulaCusto): Record<string, CardValor> {
