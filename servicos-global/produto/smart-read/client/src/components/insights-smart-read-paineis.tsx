  ...
  return (
    <>
      ...
      <CardBasicoGlobal
        ...
        tooltip={
          <>
            ...
            <p className="cg-tooltip__row">
              <span>Errados</span>
              <strong>{formatarErrosEvitadosEstudoSmartRead(metricas.camposErrados, metricas.totalCampos)}</strong>
            </p>
            <p className="cg-tooltip__row">
      ...
      <CardBasicoGlobal
        ...
        valor={carregando ? placeholder : formatarErrosEvitadosEstudoSmartRead(metricas.camposErrados, metricas.totalCampos)}
        tooltip={
          <>
            <p className="cg-tooltip__row">
      ...
      <div className="sr-insights-card__corpo">
        ...
        <div className="sr-insights-campos-box sr-insights-campos-box--erro">
          ...
          <p className="sr-insights-campos-box__valor" style={{ color: '#f87171' }}>
            {formatarErrosEvitadosEstudoSmartRead(metricas.camposErrados, metricas.totalCampos)}
          </p>
        </div>
      </div>
