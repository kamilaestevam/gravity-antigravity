...
export function getCachedKpis(tenantId: string, productId?: string): unknown | null {
  evictExpired();
...
export function setCachedKpis(tenantId: string, productId: string | undefined, data: unknown): void {
  evictExpired();
