...
export const TOKEN_PEDIDO_PARA_ITEM: Record<string, string> = {
  quantidade_total_inicial_pedido:      'quantidade_inicial_pedido_pedido_item',
  quantidade_pronta_itens_pedido_total: 'quantidade_pronta_pedido_pedido_item',
  quantidade_cancelada_total_pedido:    'quantidade_cancelada_pedido_pedido_item',
  quantidade_transferida_total:         'quantidade_transferida_pedido_pedido_item',
  saldo_itens_do_pedido:                'quantidade_atual_pedido_pedido_item',
}
