...
```
✅ "Total de usuários com acesso ativo neste Workspace"
...
```
✅ "Todo acesso deste Workspace será bloqueado imediatamente"
...
| Workspace ativa | Define qual Workspace você está operando agora |

### TabelaGlobal — workspaces

| Coluna | descricao aprovada |
|---|---|
| Workspace | Nome do Workspace cadastrado na sua conta |
| Subdomínio | Endereço exclusivo deste workspace no workspace |
| Usuários | Total de usuários com acesso habilitado neste workspace |
| Status | Indica se o workspace está operando ou com acesso suspenso |
| Criado em | Data em que o workspace foi cadastrado no sistema |
...
| Empresas vinculadas | workspaces às quais este usuário tem acesso liberado |
