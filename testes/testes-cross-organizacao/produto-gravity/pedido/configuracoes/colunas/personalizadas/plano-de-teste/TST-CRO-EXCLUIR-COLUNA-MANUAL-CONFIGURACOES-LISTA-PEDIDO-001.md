...
**Spec alvo:** `testes/testes-cross-organizacao/produto-gravity/pedido/configuracoes/colunas/personalizadas/TST-CRO-EXCLUIR-COLUNA-MANUAL-CONFIGURACOES-LISTA-PEDIDO-001.test.ts`
...
```bash
npx vitest run testes/testes-cross-organizacao/produto-gravity/pedido/configuracoes/colunas/personalizadas/TST-CRO-EXCLUIR-COLUNA-MANUAL-CONFIGURACOES-LISTA-PEDIDO-001.test.ts
```
