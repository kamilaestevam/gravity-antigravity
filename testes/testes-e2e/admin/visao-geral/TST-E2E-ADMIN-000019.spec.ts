/**
 * TST-E2E-ADMIN-000019 — Visão Geral (HQ Owner)
 * ----------------------------------------------
 * Spec executável Playwright traduzido do plano JSON em:
 *   testes/testes-e2e/admin/visao-geral/plano-teste/TST-E2E-ADMIN-000019.json
 *
 ...
 * geração via POST /admin/planos-teste/TST-E2E-ADMIN-000019/gerar-spec.
 *
 * Pré-requisitos:
 ...
 *
 * Execução:
 *   npx playwright test --project=admin testes/testes-e2e/admin/visao-geral/TST-E2E-ADMIN-000019.spec.ts
 */
...
test.describe('TST-E2E-ADMIN-000019 — Visão Geral (HQ Owner)', () => {
  ...
  test('33. URL única usegravity.com.br no card de identidade', async ({ page }) => {
    await expect(page.getByTestId('identidade-subdominio')).toHaveText('usegravity.com.br')
  })
