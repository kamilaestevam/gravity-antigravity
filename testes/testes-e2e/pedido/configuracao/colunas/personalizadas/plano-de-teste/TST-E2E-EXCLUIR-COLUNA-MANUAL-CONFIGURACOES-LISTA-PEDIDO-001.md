...
**Spec alvo:** `testes/testes-e2e/pedido/configuracao/colunas/personalizadas/TST-E2E-EXCLUIR-COLUNA-MANUAL-CONFIGURACOES-LISTA-PEDIDO-001.spec.ts`
...
```bash
npx playwright test testes/testes-e2e/pedido/configuracao/colunas/personalizadas/TST-E2E-EXCLUIR-COLUNA-MANUAL-CONFIGURACOES-LISTA-PEDIDO-001.spec.ts
```
