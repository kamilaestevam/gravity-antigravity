...
**ID:** TST-EMT-PEDIDO-CONFIG-STATUS-001  
**Data:** 2026-06-02  
**Versão:** 1.0  
**Criticidade:** alta  
...
**Script alvo:** `testes/testes-em-tela/pedido/configuracoes/status/run-status-config-reflexo.ts`  
**Pasta prints:** `testes/testes-em-tela/pedido/configuracoes/status/2026-06-02-status-reflexo-completo/`
...
2. Criar pasta `2026-06-02-status-reflexo-completo/`
...
### ETAPA 2 — Lista
1. `/pedido/pedidos/lista` → prints 09–10
2. Validar aba custom e label editado
...
Pasta: testes/testes-em-tela/pedido/configuracoes/status/2026-06-02-status-reflexo-completo/
...
```bash
npx tsx testes/testes-em-tela/pedido/configuracoes/status/run-status-config-reflexo.ts
```
