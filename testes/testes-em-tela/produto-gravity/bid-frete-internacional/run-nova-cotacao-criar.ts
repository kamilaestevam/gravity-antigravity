 ...
 * Evidência: screenshots em testes/testes-em-tela/produto-gravity/bid-frete-internacional/evidencia-nova-cotacao/
 *
 * Uso: npx tsx testes/testes-em-tela/produto-gravity/bid-frete-internacional/run-nova-cotacao-criar.ts
 */
