...
**Escopo pasta:** `testes/testes-em-tela/produto-gravity/pedido/configuracoes/colunas/personalizadas/`  
...
```bash
npx tsx testes/testes-em-tela/produto-gravity/pedido/configuracoes/colunas/personalizadas/plano-de-teste/run-excluir-coluna-personalizada.ts
```
