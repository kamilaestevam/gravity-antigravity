...
**Spec alvo:** `testes/testes-funcionais/pedido/configuracoes/colunas/personalizadas/TST-FUN-EXCLUIR-COLUNA-MANUAL-CONFIGURACOES-LISTA-PEDIDO-001.test.ts`
...
```bash
npx vitest run testes/testes-funcionais/pedido/configuracoes/colunas/personalizadas/TST-FUN-EXCLUIR-COLUNA-MANUAL-CONFIGURACOES-LISTA-PEDIDO-001.test.ts
```
