...
**Referência:** `testes/testes-funcionais/produto-gravity/bid-frete-internacional/lista/config-status-routes.test.ts`  
...
**Spec alvo:** `testes/testes-funcionais/produto-gravity/pedido/configuracoes/status/config-status-routes.test.ts`
...
```bash
npx vitest run testes/testes-funcionais/produto-gravity/pedido/configuracoes/status/
```
