...
export default defineConfig({
  ...
  test: {
    globals: true,
    environment: 'jsdom',
    include: ['testes/testes-unitarios/nucleo-global/campo-geral-global/**/*.test.tsx'],
    coverage: {
      provider: 'v8',
      reporter: ['text', 'html'],
      reportsDirectory: './testes/testes-unitarios/nucleo-global/campo-geral-global/resultados',
