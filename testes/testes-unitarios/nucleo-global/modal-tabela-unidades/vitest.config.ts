...
export default defineConfig({
  ...
  test: {
    globals: true,
    environment: 'jsdom',
    include: ['testes/testes-unitarios/nucleo-global/modal-tabela-unidades/**/*.test.ts'],
    coverage: {
      provider: 'v8',
      reporter: ['text', 'html'],
      reportsDirectory: './testes/testes-unitarios/nucleo-global/modal-tabela-unidades/resultados',
