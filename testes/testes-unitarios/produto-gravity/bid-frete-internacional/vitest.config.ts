...
export default defineConfig({
  ...
  test: {
    environment: 'jsdom',
    globals: true,
    include: ['testes/testes-unitarios/produto-gravity/bid-frete-internacional/**/*.test.ts'],
    coverage: {
      provider: 'v8',
      reporter: ['text', 'html'],
      reportsDirectory: './testes/testes-unitarios/produto-gravity/bid-frete-internacional/resultados',
      include: [
