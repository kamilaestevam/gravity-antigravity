...
**Spec alvo:** `testes/testes-unitarios/produto-gravity/pedido/configuracoes/colunas/personalizadas/TST-UNI-EXCLUIR-COLUNA-MANUAL-CONFIGURACOES-LISTA-PEDIDO-001.test.tsx`
...
```bash
npx vitest run testes/testes-unitarios/produto-gravity/pedido/configuracoes/colunas/personalizadas/TST-UNI-EXCLUIR-COLUNA-MANUAL-CONFIGURACOES-LISTA-PEDIDO-001.test.tsx
```
