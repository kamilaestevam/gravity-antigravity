...
**Spec alvo:** `testes/testes-unitarios/produto-gravity/pedido/configuracoes/status/status-pedido-config.test.ts`  
**Legado a consolidar:** `testes/testes-unitarios/produto-gravity/pedido/status-pedido-sistema.test.ts` (2 testes existentes)
...
```bash
npx vitest run testes/testes-unitarios/produto-gravity/pedido/configuracoes/status/
```
