...
- `testes/testes-unitarios/produto-gravity/pedido/duplicar-opcoes-zeramento.test.ts` — 15 casos cobrindo `aplicarZeramentoOpcoes`. Manter como está (`origem: existente`).
...
```
testes/testes-unitarios/produto-gravity/pedido/lista/duplicar/plano-de-teste/
