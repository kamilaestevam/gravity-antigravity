...
**Escopo pasta:** `testes/testes-unitarios/produto-gravity/pedido/lista/edicao-em-massa/`  
...
**Pacote 5 tipos (Local):** `npx tsx testes/testes-em-tela/produto-gravity/pedido/lista/edicao-em-massa/plano-de-teste/run-pacote-edicao-em-massa-local.ts`  
